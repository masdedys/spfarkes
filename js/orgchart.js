var OrgChart = function (t, e) {
  var r = this;
  if (
    (("string" == typeof t || t instanceof String) && (t = document.querySelector(t)),
    (this.element = t),
  ...
  (this._event_id = OrgChart._guid()),
    OrgChart._validateConfig(this.config) &&
      ...
      this.config.filterUI ? (this.filterUI = this.config.filterUI) : (this.filterUI = new OrgChart.filterUI()),
      ...
      this.config.undoRedoUI ? (this.undoRedoUI = this.config.undoRedoUI) : (this.undoRedoUI = new OrgChart.undoRedoUI()),
      ...
      OrgChart._intersectionObserver(this.element, function (t) {
        (r.isVisible = t),
          !1 !== OrgChart.events.publish("visibility-change", [r]) && OrgChart.LAZY_LOADING && r.isVisible && (r._loaded ? r._draw(!1, OrgChart.action.update) : (r._setInitialSizeIfNotSet(), r._draw(!1, OrgChart.action.init)));
      }));
};
(OrgChart._defaultConfig = function (t) {
  return {
    ...
    editForm: {
      ...
      focusBinding: null,
      buttons: {
        edit: { icon: OrgChart.icon.edit(24, 24, "#fff"), text: "Edit", hideIfEditMode: !0, hideIfDetailsMode: !1 },
  ...
  (OrgChart.prototype._draw = function (t, e, r, i) {
    ...
    if (!OrgChart.LAZY_LOADING || this.isVisible)
      if (OrgChart.LAZY_LOADING || this._initialized || (this._setInitialSizeIfNotSet(), 0 != this.width() && 0 != this.height())) {
              ...
              if ((OrgChart.events.publish("render", [a, n]), (o = n.content), (t = n.res), (o += a.ui.lonely(a.config)), e !== OrgChart.action.exporting)) {
                ...
                e === OrgChart.action.centerNode
                  ...
                  : !s ||
                    ...
                    (e !== OrgChart.action.insert && e !== OrgChart.action.expand && e !== OrgChart.action.collapse && e !== OrgChart.action.update && e !== OrgChart.action.init)
                  ? 0 == m[0].length && (f || (i && i(), OrgChart.events.publish("redraw", [a]), (f = !0)))
                  : OrgChart.animate(a.getSvg(), { viewbox: s }, { viewbox: a.response.viewBox }, 2 * a.config.anim.duration, a.config.anim.func, function () {
                      a.xScrollUI.setPosition(), a.yScrollUI.setPosition(), f || (i && i(), OrgChart.events.publish("redraw", [a]), (f = !0));
                    }),
                  a._initialized || ((a._initialized = !0), a.filterUI.update(), OrgChart.events.publish("init", [a])),
                  !a._loaded && t && t.nodes && Object.keys(t.nodes).length && (a._loaded = !0);
              } else {
                var C = t.boundary,
                  b = C.maxX - C.minX,
                  O = C.maxY - C.minY,
  ...
  (OrgChart.prototype.setScale = function (t) {
    ...
    var e = this.getViewBox().slice(0),
      ...
      s = e[2],
      h = e[3];
    return (e[2] = e[2] / (t / o)), (e[3] = e[3] / (t / o)), (e[0] = l[0] - (e[2] - s) / 2), (e[1] = l[1] - (e[3] - h) / 2), this.setViewBox(e), OrgChart.events.publish("redraw", [this]), t;
  }),
    ...
    if (null != i) {
      ...
      if (null != a) {
        ...
        OrgChart.events.publish("ripple", [this, O]),
          ...
          u.appendChild(C),
          a.appendChild(u),
          OrgChart.animate(C, { r: 0, opacity: 1 }, { r: p, opacity: 0 }, 500, OrgChart.anim.outPow, function () {
            a.removeChild(u);
          });
      }
    }
  ...
  (OrgChart.prototype.setLayout = function (t, e) {
    e || (e = "base"), (this._layoutConfigs[e].layout = t), "base" == e && (this.config.layout = t), this._draw(!1, OrgChart.action.update);
  }),
  (OrgChart.prototype.setOrientation = function (t, e, r) {
    ...
    e || (e = "base"),
      ...
      this._draw(!1, OrgChart.action.update, void 0, function () {
        OrgChart._moveToBoundaryArea(i.getSvg(), i.getViewBox(), i.response.boundary, function () {
  ...
  (OrgChart.prototype.search = function (t, e, r) {
    return (
      ...
      OrgChart._search.search(this.config.nodes, t, e, r, this.config.searchDisplayField, this.config.searchFieldsWeight, this.searchUI._searchFieldsAbbreviation)
    );
  }),
  ...
  (OrgChart.prototype.updateNode = function (t, e, r) {
    ...
    this.update(t), OrgChart.events.publish("updated", [this]), this.filterUI.update();
  ...
  (OrgChart.prototype.removeNode = function (t, e, r) {
    ...
    return (
      ...
      this._draw(!1, OrgChart.action.update, null, function () {
        i.config.sticky && OrgChart._moveToBoundaryArea(i.getSvg(), i.getViewBox(), i.response.boundary), e && e();
      }),
      !0
    );
  }),
  (OrgChart.prototype.remove = function (t) {
    ...
    if (e) {
      ...
      for (var r = this.config.nodes.length - 1; r >= 0; r--)
        (this.config.nodes[r].pid != t && this.config.nodes[r].stpid != t) || ((this.config.nodes[r].pid = e.pid), (this.config.nodes[r].stpid = e.stpid)), this.config.nodes[r].id == t && this.config.nodes.splice(r, 1);
    }
    return this;
  }),
  ...
  (OrgChart.prototype.add = function (t) {
    if ((null == t.id && console.error("Call addNode without id"), this._putInUndoStack(), this.clearRedo(), this.config.draggable && !OrgChart.isNEU(t.pid))) {
      var e = this._get(t.pid);
      e && (null != e.movex && (t.movex = e.movex), null != e.movey && (t.movey = e.movey));
    }
  ...
  (OrgChart.prototype._replaceIds = function (t) {
    for (
      ...
      for (var a in t) {
        var n = t[a];
        i.id == a && (i.id = n), i.pid == a && (i.pid = n), i.stpid == a && (i.stpid = n), i.ppid == a && (i.ppid = n);
      }
    }
    if (Array.isArray(this.config.roots)) for (r = 0; r < this.config.roots.length; r++) this.config.roots[r] == a && (this.config.roots[r] = n);
    if (this.nodes)
    ...
    if (this.manager.oldNodes)
      for (var o in this.manager.oldNodes) {
        if (o == a) ((l = this.manager.oldNodes[o]).id = n), (this.manager.oldNodes[n] = l);
      }
    if (this.roots)
    ...
    e(this.config.clinks), e(this.config.slinks), e(this.config.groupDottedLines), e(this.config.dottedLines);
  }),
  (OrgChart.prototype._get = function (t) {
    var e = this.__get(t);
    if (e) return e;
    if ((this.config.groupDottedLines.length || this.config.dottedLines.length) && !OrgChart.isNEU(t) && "string" == typeof t && (-1 != t.indexOf("balkan_group_dotted_") || -1 != t.indexOf("balkan_dotted_"))) {
      var r = (t = (t = t.replace("balkan_group_dotted_", "")).replace("balkan_dotted_", "")).indexOf("_balkan_id_");
      if (((t = t.substring(r + "_balkan_id_".length)), (e = this.__get(t)))) return e;
    }
    return null;
  }),
            ...
            switch (g.toLowerCase()) {
              ...
              case "transform":
                if (r[c][g]) {
                  ...
                  for (var v in C) O[v] = a((h * s - s) / i) * (b[v] - C[v]) + C[v];
                  t[c].hasAttribute("transform") ? t[c].setAttribute("transform", "matrix(" + O.toString() + ")") : (t[c].style.transform = "matrix(" + O.toString() + ")");
                }
                break;
              case "viewbox":
                if (r[c][g]) {
  ...
  (OrgChart.anim.inOutExp = function (t) {
    return t < 0 ? 0 : t > 1 ? 1 : t < 0.5 ? 0.5 * Math.pow(2, 10 * (2 * t - 1)) : 0.5 * (2 - Math.pow(2, 10 * (-2 * t + 1)));
  }),
  ...
  (OrgChart.anim.inOutCirc = function (t) {
    return t < 0 ? 0 : t > 1 ? 1 : t < 1 ? -0.5 * (Math.sqrt(1 - t * t) - 1) : 0.5 * (Math.sqrt(1 - (2 * t - 2) * (2 * t - 2)) + 1);
  }),
  ...
  (OrgChart.anim.inOutBack = function (t) {
    return t < 0 ? 0 : t > 1 ? 1 : t < 0.5 ? 4 * t * t * (7.1898 * t - 2.5949) * 0.5 : 0.5 * ((2 * t - 2) * (2 * t - 2) * (3.5949 * (2 * t - 2) + 2.5949) + 2);
  }),
    ...
    if (this.config.interactive) {
      ...
      this.config.enableTouch || OrgChart.isMobile()
        ...
        : (this._addEvent(t, "mousedown", this._globalMouseDownHandler),
          ...
          this.config.mouseScrool != OrgChart.action.none && this._addEvent(t, "wheel", this._mouseScrollHandler));
  ...
  (OrgChart.prototype._addEvent = function (t, e, r, i) {
    var a, n;
    (i || (i = ""), t.getListenerList || (t.getListenerList = {}), t.getListenerList[e + i]) ||
      ((a = this),
      (n = r),
      (r = function () {
  ...
  (OrgChart.editUI.prototype.show = function (t, e, r) {
    ...
    this.obj.element.appendChild(a.element),
      ...
      r
        ...
        : (this.interval = OrgChart.animate(a.element, { right: -20, opacity: 0 }, { right: 0, opacity: 1 }, 300, OrgChart.anim.outSin, function () {
    ...
    for (var n = this.obj.element.querySelectorAll("[data-input-btn]"), o = 0; o < n.length; o++) {
      n[o].addEventListener("click", function (e) {
        e.preventDefault(), OrgChart.events.publish("element-btn-click", [i, { input: this.parentNode.querySelector("input"), nodeId: t, event: e }]);
      });
    }
    this.obj.element.querySelector("[data-add-more-fields-btn]").addEventListener("click", function (t) {
      t.stopPropagation(), t.preventDefault();
      var e = this,
        r = OrgChart.elements.textbox({}, { type: "textbox", label: i.obj.config.editForm.addMoreFieldName, btn: i.obj.config.editForm.addMoreBtn }, "280px");
      ...
      a.focus(),
        a.nextElementSibling.addEventListener("click", function (t) {
          t.stopPropagation(), t.preventDefault();
          var r = a.value,
            n = i.obj.element.querySelector('[data-binding="' + OrgChart._escapeDoubleQuotes(a.value) + '"]');
          if (OrgChart.isNEU(r) || n) a.focus();
          else {
            var o = OrgChart.elements.textbox({}, { type: "textbox", label: r, binding: r }, "280px");
  ...
  (OrgChart.editUI.prototype._focusElement = function (t) {
    var e = null;
    OrgChart.isNEU(this.obj.config.editForm.focusBinding) ? OrgChart.isNEU(t) || (e = document.getElementById(t)) : (e = this.obj.element.querySelector('[data-binding="' + this.obj.config.editForm.focusBinding + '"]')),
      e && (e.value && e.value.length && e.setSelectionRange(e.value.length, e.value.length), e.focus());
  }),
  ...
  (OrgChart.editUI.prototype.content = function (t, e, r, i, a) {
    ...
    (L.style.display = "flex"), (L.style.opacity = r ? 1 : 0), (L.style.right = r ? 0 : "-20px"), i && (L.style.width = i);
    var A = [],
    ...
    return (
        ...
        for (var t = "", r = 0; r < l.length; r++) {
          ...
          if (Array.isArray(i)) {
            ...
            for (var a = 0; a < i.length; a++) {
              ...
              !OrgChart.isNEU(s.id) && OrgChart.isNEU(n) && OrgChart.isNEU(s.value) && (n = s.id), OrgChart.isNEU(s.value) || A.push(`${o.label}: ${s.value}`), (t += s.html);
            }
            t += "</div>";
          } else {
            s = OrgChart.elements[i.type](f, i, "280px", e);
            !OrgChart.isNEU(s.id) && OrgChart.isNEU(n) && OrgChart.isNEU(s.value) && (n = s.id), OrgChart.isNEU(s.value) || A.push(`${i.label}: ${s.value}`), (t += s.html);
          }
        }
        return t;
      ...
      { element: L, focusId: n, title: C, shareText: A.join("\n") }
    );
  }),
  ...
  (OrgChart.editUI.renderHeaderContent = function (t, e, r, i) {
    return `<h1 class="boc-edit-form-title">${OrgChart._escapeGreaterLessSign(t)}</h1>\n                <div id="boc-avatar" class="boc-edit-form-avatar">${e}</div>`;
  }),
  ...
  (OrgChart.prototype.getNodeElement = function (t) {
    return this.element.querySelector("[" + OrgChart.attr.node_id + "='" + t + "']");
  }),
  ...
  (OrgChart.menuUI.prototype._show = function (t, e, r, i, a) {
    ...
    for (var s in (a = l.menu)) {
      var h = a[s].icon,
        d = a[s].text;
      void 0 === h && (h = OrgChart.icon[s] ? OrgChart.icon[s](24, 24, "#7A7A7A") : ""),
        "function" == typeof d && (d = d()),
        "function" == typeof h && (h = h()),
        (o += "<div " + OrgChart.attr.item + '="' + s + '">' + h + "<span>&nbsp;&nbsp;" + d + "</span></div>");
    }
    if ("" != o) {
      if (
      ...
      OrgChart.animate(this.wrapper, { opacity: 0, left: g - this.wrapper.offsetWidth }, { opacity: 1, left: p }, 300, OrgChart.anim.inOutPow);
          ...
          if (void 0 === a[o].onClick)
            if ("add" === o) {
              ...
              "remove" === o
                ...
                : "svg" === o
                ? n.obj.exportSVG({ filename: "OrgChart.svg", expandChildren: !1, nodeId: r })
                : "pdf" === o
                ? n.obj.exportPDF({ filename: "OrgChart.pdf", expandChildren: !1, nodeId: r })
                : "png" === o
                ? n.obj.exportPNG({ filename: "OrgChart.png", expandChildren: !1, nodeId: r })
                : "csv" === o
  ...
  (OrgChart.circleMenuUI.prototype._show = function (t, e) {
    ...
    if (!OrgChart.isNEU(a.nodeCircleMenuButton)) {
      ...
      if (OrgChart.isNEU(p) || p.getAttribute(OrgChart.attr.control_node_circle_menu_wrraper_id) != t) {
        ...
        for (var m = 0, C = Object.keys(u.menu).length, b = 2 * a.nodeCircleMenuButton.radius + 4, O = 2 * Math.PI * b, v = O / C - (2 * a.nodeCircleMenuButton.radius + 2); v < 0; )
          (b += 8), (v = (O = 2 * Math.PI * b) / C - (2 * a.nodeCircleMenuButton.radius + 2));
        for (var y in ((p = document.createElementNS("http://www.w3.org/2000/svg", "g")).setAttribute(OrgChart.attr.control_node_circle_menu_wrraper_id, t),
        ...
        u.menu)) {
          ...
          k.setAttribute("transform", "matrix(1,0,0,1,0,0)"), k.setAttribute(OrgChart.attr.control_node_circle_menu_name, y), (k.style.cursor = "pointer");
          ...
          I.setAttribute("cx", 0),
            ...
            (k.innerHTML += x),
            p.appendChild(k);
          var L = k.getElementsByTagName("svg")[0];
          if ((L.setAttribute("pointer-events", "none"), L)) {
            var A = parseInt(L.getAttribute("width")),
              N = parseInt(L.getAttribute("height"));
            L.setAttribute("x", -A / 2), L.setAttribute("y", -N / 2);
          }
          var E = (m * Math.PI) / (C / 2);
          m++;
          var M = Math.cos(E) * b,
          ...
          this._buttonsInterval.push(
            OrgChart.animate(k, { transform: [1, 0, 0, 1, 0, 0] }, { transform: [1, 0, 0, 1, M, T] }, 250, OrgChart.anim.outBack, function (t) {
              ...
              t[0].addEventListener("mouseenter", function (t) {
                OrgChart.events.publish("mouseenter", [r, { from: i, menuItem: u.menu[e], menuItemName: e, event: t }]);
              }),
                t[0].addEventListener("mouseout", function (t) {
                  OrgChart.events.publish("mouseout", [r, { from: i, menuItem: u.menu[e], menuItemName: e, event: t }]);
                });
            })
          );
        }
        this._linesInterval.push(OrgChart.animate(g[0], { x1: -a.nodeCircleMenuButton.radius / 2, y1: -6, x2: a.nodeCircleMenuButton.radius / 2, y2: -6 }, { x1: -7, y1: -7, x2: 7, y2: 7 }, 500, OrgChart.anim.inOutSin)),
          this._linesInterval.push(OrgChart.animate(g[1], { x1: -a.nodeCircleMenuButton.radius / 2, y1: 0, x2: a.nodeCircleMenuButton.radius / 2, y2: 0 }, { x1: 0, y1: 0, x2: 0, y2: 0 }, 500, OrgChart.anim.inOutSin)),
          this._linesInterval.push(OrgChart.animate(g[2], { x1: -a.nodeCircleMenuButton.radius / 2, y1: 6, x2: a.nodeCircleMenuButton.radius / 2, y2: 6 }, { x1: -7, y1: 7, x2: 7, y2: -7 }, 500, OrgChart.anim.inOutSin));
      } else this.hide();
    }
  }),
  ...
  void 0 === OrgChart && (OrgChart = {}),
  (OrgChart.idb = { version: 1, dbName: "BALKAN", tableName: "orgchart-js", keyPath: "id" }),
  ...
  (OrgChart.toolbarUI.prototype.init = function (t, e) {
    if (e) {
      (this.obj = t),
        ...
        e.zoom &&
          ((this.div.innerHTML += "<div " + OrgChart.attr.tlbr + '="plus">' + OrgChart.toolbarUI.zoomInIcon + "</div>"), (this.div.innerHTML += "<div " + OrgChart.attr.tlbr + '="minus">' + OrgChart.toolbarUI.zoomOutIcon + "</div>")),
        e.layout &&
  ...
  (OrgChart.toolbarUI.prototype.showLayout = function () {
    (this._visible = !0),
      ...
      OrgChart.animate(this.div, { bottom: this.obj.config.padding - 10 }, { bottom: this.obj.config.padding + 135 }, this.obj.config.anim.duration, this.obj.config.anim.func),
      OrgChart.animate(this.layouts, { bottom: -145 }, { bottom: 0 }, this.obj.config.anim.duration, this.obj.config.anim.func);
  }),
  (OrgChart.toolbarUI.prototype.hideLayout = function () {
    (this._visible = !1),
      (this.layoutBtn.style.transform = "rotate(0deg) translateX(0px) translateY(0px)"),
      OrgChart.animate(this.div, { bottom: this.obj.config.padding + 135 }, { bottom: this.obj.config.padding - 10 }, this.obj.config.anim.duration, this.obj.config.anim.func),
      OrgChart.animate(this.layouts, { bottom: 0 }, { bottom: -145 }, this.obj.config.anim.duration, this.obj.config.anim.func);
  }),
  ...
  (OrgChart.notifierUI.prototype.show = function (t, e) {
    ...
    var n = r.offsetWidth;
    return (r.style.width = "20px"), OrgChart.animate(r, { opacity: 0, width: 10 }, { opacity: 1, width: n }, this.obj.config.anim.duration, this.obj.config.anim.func), !0;
  }),
  void 0 === OrgChart && (OrgChart = {}),
  (OrgChart.icon = {}),
  ...
  (OrgChart.prototype._defaultExportOptions = function (t, e) {
    return (
      ...
      "pdf" == e && null == t.footer ? (t.footer = "Page {current-page} of {total-pages}") : null == t.footer && (t.footer = ""),
      ...
      this._draw(!1, OrgChart.action.exporting, i, function (i) {
        ...
        if ("svg" == t.ext)
          if (e) e(t, a.innerHTML);
            ...
            var l = { content: a.innerHTML, options: t, styles: "" },
            ...
            OrgChart._downloadFile(t.mime, l.content, l.options.filename, l.options.openInNewTab, l.options.ext);
          }
        else
              ...
              e
                ...
                : ((n = JSON.stringify(n)),
                  OrgChart._ajax(r.config.exportUrl + "/v3", "POST", n, "arraybuffer", function (e) {
                    ...
                    OrgChart._downloadFile(t.mime, e, t.filename, t.openInNewTab, t.ext);
                  }));
          });
      });
  }),
  (OrgChart.prototype.exportCSV = function (t) {
    var e = OrgChart._defaultExportProfileOptionsForCSV_SVG_JSON(t, "csv"),
      ...
      i = null;
    r ? ((i = []), OrgChart._exportIterateForJSON_XML_CSV(this, r, e, i)) : !1 === e.min || !1 === e.expandChildren ? OrgChart._exportIterateForJSON_XML_CSV(this, this.roots, e, i) : (i = JSON.parse(JSON.stringify(this.config.nodes)));
    ...
    var n = OrgChart._json2csv(a.nodes),
      o = { ext: a.ext, filename: a.filename, options: e, nodes: a.nodes, content: n };
    if (!1 === OrgChart.events.publish("exportend", [this, o])) return !1;
    OrgChart._downloadFile("text/csv;charset=utf-8;", "\ufeff" + o.content, o.options.filename, o.options.openInNewTab, o.ext);
  }),
  (OrgChart.prototype.exportXML = function (t) {
    ...
    var n = OrgChart._json2xml(a.nodes),
      o = { ext: a.ext, filename: a.filename, options: e, nodes: a.nodes, content: n };
    if (!1 === OrgChart.events.publish("exportend", [this, o])) return !1;
    OrgChart._downloadFile("application/xml", o.content, o.options.filename, o.options.openInNewTab, o.ext);
  }),
  (OrgChart.prototype.exportJSON = function (t) {
    ...
    if (!1 === OrgChart.events.publish("exportstart", [this, a])) return !1;
    var n = { ext: a.ext, filename: a.filename, options: e, nodes: a.nodes, content: JSON.stringify(a.nodes) };
    if (!1 === OrgChart.events.publish("exportend", [this, n])) return !1;
    OrgChart._downloadFile("application/json", n.content, n.options.filename, n.options.openInNewTab, n.ext);
  }),
  (OrgChart._exportIterateForJSON_XML_CSV = function (t, e, r, i) {
    if (Array.isArray(e)) for (var a = 0; a < e.length; a++) OrgChart._exportIterateForJSON_XML_CSV(t, e[a], r, i);
    else {
      var n = t.get(e.id);
      if ((i.push(n), r.min)) for (a = 0; a < e.stChildrenIds.length; a++) OrgChart._exportIterateForJSON_XML_CSV(t, t.getNode(e.stChildrenIds[a]), r, i);
      else for (a = 0; a < e.stChildren.length; a++) OrgChart._exportIterateForJSON_XML_CSV(t, e.stChildren[a], r, i);
      if (r.expandChildren) for (a = 0; a < e.childrenIds.length; a++) OrgChart._exportIterateForJSON_XML_CSV(t, t.getNode(e.childrenIds[a]), r, i);
      else for (a = 0; a < e.children.length; a++) OrgChart._exportIterateForJSON_XML_CSV(t, e.children[a], r, i);
    }
  }),
  ...
  (OrgChart.prototype._pagesA100 = function (t, e, r) {
    ...
    var o = i[0],
      ...
      s = i[2],
      h = i[3],
      d = { w: t.landscape ? n - (t.margin[1] + t.margin[3]) : a - (t.margin[1] + t.margin[3]), h: t.landscape ? a - (t.margin[0] + t.margin[2]) : n - (t.margin[0] + t.margin[2]) },
    ...
    for (var g = d.w * (100 / r), p = d.h * (100 / r), u = o, f = l, m = []; u < s + o; ) {
      for (; f < h + l; ) {
        var C = [u, f, g, p];
        (C = C.join()), m.push({ vb: C, innerSize: d, size: c }), (f += p);
      }
      (u += g), (f = l);
    }
    return m;
  ...
  (OrgChart.prototype._defaultExportProfileOptions = function (t, e) {
    return (
      (OrgChart.isNEU(t) || OrgChart.isNEU(t.id)) && console.error("options.id is not defilned"),
      "svg" == e ? ((t.ext = "svg"), (t.mime = "image/svg+xml")) : "pdf" == e ? ((t.mime = "application/pdf"), (t.ext = "pdf")) : "png" == e && ((t.mime = "image/png"), (t.ext = "png")),
      null == t.margin && (t.margin = [50, 40, 50, 40]),
      null == t.padding && (t.padding = 0),
      null == t.landscape && (t.landscape = !1),
  ...
  (OrgChart.prototype._exportProfile = function (t, e) {
    ...
    var n = { w: t.landscape ? a - (t.margin[1] + t.margin[3]) : i - (t.margin[1] + t.margin[3]), h: t.landscape ? i - (t.margin[0] + t.margin[2]) : a - (t.margin[0] + t.margin[2]) },
    ...
    if (d) for (var c = 0; c < d.children.length; c++) "style" == d.children[c].nodeName.toLowerCase() && (s.styles += d.children[c].outerHTML);
    (s = JSON.stringify(s)),
      OrgChart._ajax(this.config.exportUrl + "/v3", "POST", s, "arraybuffer", function (i) {
        if (e) e(r, i);
          ...
          OrgChart._downloadFile(t.mime, i, t.filename, t.openInNewTab, t.ext);
        }
      });
  }),
  void 0 === OrgChart && (OrgChart = {}),
      ...
      remove: function (e, r, i) {
        ...
        if (t[e] && Array.isArray(t[e]) && t[e].length > 0)
          for (var n = t[e].length - 1; n >= 0; n--)
            ((!OrgChart.isNEU(i) && !OrgChart.isNEU(r) && t[e][n].event_id == i && t[e][n].listener == r) ||
              (!OrgChart.isNEU(i) && OrgChart.isNEU(r) && t[e][n].event_id == i) ||
              (OrgChart.isNEU(i) && !OrgChart.isNEU(r) && t[e][n].listener == r) ||
          ...
          if (i.length > 0) {
            ...
            for (
              ...
              (1 == r.length
                ...
                : 5 == r.length && (o = i[a](r[0], r[1], r[2], r[3], r[4]) && o),
              !1 !== o);
              a++
            );
            return o;
      ...
      (e.onchange = function (e) {
        ...
        (i.onload = function () {
          ...
          OrgChart._importSetColumnNames(n, function (e) {
            ...
            0 != OrgChart.events.publish("import", [t, h]) && (t._putInUndoStack(), t.clearRedo(), (t.config.nodes = h.nodes), OrgChart.events.publish("updated", [t]), t.filterUI.update(), t.draw());
          });
        }),
    ...
    e.setAttribute("type", "file"),
      ...
      (e.onchange = function (e) {
        ...
        (i.onload = function () {
          ...
          0 != OrgChart.events.publish("import", [t, r]) && (t._putInUndoStack(), t.clearRedo(), (t.config.nodes = r), OrgChart.events.publish("updated", [t]), t.filterUI.update(), t.draw());
        }),
          i.readAsText(r.files[0]);
      }),
      e.click();
  ...
  (OrgChart.prototype._globalClickHandler = function (t, e) {
    ...
    for (var l = e.target; l != t; ) {
      ...
      if (l.hasAttribute(OrgChart.attr.c_link_from)) return void OrgChart.events.publish("clink-click", [this, { from: l.getAttribute(OrgChart.attr.c_link_from), to: l.getAttribute(OrgChart.attr.c_link_to), event: e }]);
      if (l.hasAttribute(OrgChart.attr.s_link_from)) return void OrgChart.events.publish("slink-click", [this, { from: l.getAttribute(OrgChart.attr.s_link_from), to: l.getAttribute(OrgChart.attr.s_link_to), event: e }]);
      l = l.parentNode;
    }
  }),
  ...
  (OrgChart.prototype._nodeContextHandler = function (t, e) {
    e.preventDefault(), OrgChart.SEARCH_CLOSE_RESULT_ON_ESCAPE_OR_CLICKOUTSIDE && this.searchUI.hide(), this.nodeMenuUI.hide(), this.nodeContextMenuUI.hide(), this.menuUI.hide(), this.nodeCircleMenuUI.hide();
    var r = this.get(t),
      i = null;
  ...
  (OrgChart.prototype._nodeCircleNodeMenuItemMouseDownHandler = function (t, e, r) {
    ...
    if (n.draggable) {
      ...
      u.setAttribute("transform", "matrix(1,0,0,1," + (m + b.x) + "," + (C + b.y) + ")"), (u.style.opacity = 0.7);
      var O = function (t, e) {
          if (null != t) {
        ...
        v = function (e) {
          if (p) {
            ...
            var l = OrgChart._getOffsetXY(o.element, e),
              s = { left: o.width() - (l.x + o.config.padding) < 0, right: l.x - o.config.padding < 0, up: o.height() - (l.y + o.config.padding) < 0, down: l.y - o.config.padding < 0 };
            if (s.left || s.right || s.up || s.down) {
              ...
              o.moveStart(s, function (t) {
                (f[4] = v + t.x), (f[5] = x + t.y), (p.x = _ - t.xWithoutScale), (p.y = w - t.yWithoutScale), (r.x = k - t.xWithoutScale), (r.y = S - t.yWithoutScale), u.setAttribute("transform", "matrix(" + f.toString() + ")");
              });
            } else {
              for (
                o.moveEnd(), g.classList && (g.classList.add("boc-cursor-grab"), g.classList.remove("boc-cursor-move"), g.classList.remove("boc-cursor-nodrop"), g.classList.remove("boc-cursor-copy")), O(d, c), d = null, c = null;
                null != i && i != g;
              ...
              if (null != d) {
                ...
                for (var L = o.getNode(d), A = OrgChart.getStParentNodes(L), N = 0; N < A.length; N++) {
                  var E = o.getNodeElement(A[N].id);
              ...
              var M = (r.x - p.x) / h,
                T = (r.y - p.y) / h;
              if (((f[4] = m + M), (f[5] = C + T), !t._dragEventFired && (Math.abs(r.x - p.x) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(r.y - p.y) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE)))
                !1 === OrgChart.events.publish("drag", [o.nodeCircleMenuUI, { from: I, menuItem: n, menuItemName: a }]) && y(), (t._dragEventFired = !0);
        ...
        y = function (e) {
          if (
            (o.moveEnd(),
            g.classList && (g.classList.remove("boc-cursor-grab"), g.classList.remove("boc-cursor-move"), g.classList.remove("boc-cursor-nodrop"), g.classList.remove("boc-cursor-copy")),
            g.removeEventListener(r.move, v),
            g.removeEventListener(r.up, y),
            r.leave && g.removeEventListener(r.leave, y),
            s.id == d || null == d)
          )
            return g.removeChild(u), (o._gragStartedId = null), void (t._dragEventFired && OrgChart.events.publish("drop", [o.nodeCircleMenuUI, { from: s.id, menuItemName: a, menuItem: n, event: e }]));
          var i = o.getNode(d);
          OrgChart.events.publish("drop", [o.nodeCircleMenuUI, { from: s.id, to: i.id, menuItem: n, menuItemName: a, event: e }]), O(d, c), g.removeChild(u), (o._gragStartedId = null);
        };
      g.addEventListener(r.move, v), g.addEventListener(r.up, y), r.leave && g.addEventListener(r.leave, y);
    }
  }),
  (OrgChart.prototype._nodeMouseDownHandler = function (t, e, r) {
    this.config.draggable ? this._draggableHandler(t, e, r) : this.config.enableDragDrop && this._dragDropHandler(t, e, r);
  }),
  (OrgChart.prototype._draggableHandler = function (t, e, r) {
    var i = this,
      a = t.getAttribute(OrgChart.attr.node_id);
    if (this.roots) for (var n = 0; n < this.roots.length; n++) if (this.roots[n].id == a) return;
    var o = [],
      l = function (t, e) {
        if (Array.isArray(t)) for (var r = 0; r < t.length; r++) l(t[r], e);
        else {
          e.push(t.id);
          for (r = 0; r < t.stChildren.length; r++) l(t.stChildren[r], e);
          for (r = 0; r < t.children.length; r++) l(t.children[r], e);
        }
      };
    l(this.getNode(a), o);
    for (var s = this.getSvg(), h = OrgChart._getClientXY(e), d = [], c = [], g = [], p = [], u = [], f = [], m = [], C = [], b = 0; b < o.length; b++) {
      var O = this.getNode(o[b]);
      d.push(O), g.push({ x: O.x, y: O.y });
      var v = this.getNodeElement(o[b]);
      u.push(v);
      var y = OrgChart._getTransform(v);
      p.push({ x: y[4], y: y[5] }), c.push(y);
      var x = this.element.querySelector(`[data-ctrl-ec-id="${o[b]}"]`);
      if (x) {
        f.push(x);
        var _ = OrgChart._getTransform(x);
        m.push(_), C.push({ x: _[4], y: _[5] });
      } else f.push(null), m.push(null), C.push(null);
      if (this.config.draggable == OrgChart.draggable.node) break;
    }
    t._dragEventFired = !1;
    var w = null,
      k = null;
    ...
    var S = { x: h.x, y: h.y },
      ...
      L = function (t, e) {
        if (null != t) {
          e.classList.remove("boc-drag-over");
          for (var r = i.getNode(w), a = OrgChart.getStParentNodes(r), n = 0; n < a.length; n++) {
      ...
      A = function (e) {
        if (S) {
          var r = OrgChart._getClientXY(e),
            n = e.target;
          OrgChart.isMobile() && (n = document.elementFromPoint(r.x, r.y));
          var l = OrgChart._getOffsetXY(i.element, e),
            h = { left: i.width() - (l.x + i.config.padding) < 0, right: l.x - i.config.padding < 0, up: i.height() - (l.y + i.config.padding) < 0, down: l.y - i.config.padding < 0 };
          if (h.left || h.right || h.up || h.down) {
            s.classList && (s.classList.remove("boc-cursor-grab"), s.classList.add("boc-cursor-move"), s.classList.remove("boc-cursor-nodrop"), s.classList.remove("boc-cursor-copy"));
            for (var b = [], O = [], v = [], y = [], x = 0; x < c.length; x++) b.push(c[x][4]), O.push(c[x][5]), m[x] ? (v.push(m[x][4]), y.push(m[x][5])) : (v.push(null), y.push(null));
            var _ = S.x,
              A = S.y,
              E = r.x,
              M = r.y;
            i.moveStart(h, function (t) {
              for (var e = 0; e < c.length; e++) {
                ...
                (c[e][4] = a + t.x),
                  (c[e][5] = n + t.y),
                  (S.x = _ - t.xWithoutScale),
                  (S.y = A - t.yWithoutScale),
                  (r.x = E - t.xWithoutScale),
                  (r.y = M - t.yWithoutScale),
                  (d[e].x = a + t.x),
                  (d[e].y = n + t.y),
                  (d[e].movex = t.x),
                  (d[e].movey = t.y),
                  m[e] && ((m[e][4] = o + t.x), (m[e][5] = l + t.y));
                for (var s = OrgChart.ui.link(d[e], i, I, i.response.bordersByRootIdAndLevel, i.nodes, OrgChart.action.update, !0), h = 0; h < s.length; h++) {
                  var g = s[h];
                  (p = i.element.querySelector(`[data-l-id="[${g.id}][${g.childId}]"]`)) && (p.innerHTML = g.html);
                }
                if (d[e].parent)
                  for (s = OrgChart.ui.link(d[e].parent, i, I, i.response.bordersByRootIdAndLevel, i.nodes, OrgChart.action.update, !0), h = 0; h < s.length; h++) {
                    var p;
                    g = s[h];
                    (p = i.element.querySelector(`[data-l-id="[${g.id}][${g.childId}]"]`)) && (p.innerHTML = g.html);
                  }
                u[e].setAttribute("transform", "matrix(" + c[e].toString() + ")"), f[e] && f[e].setAttribute("transform", "matrix(" + m[e].toString() + ")");
              }
            });
          } else {
            if (
              (i.moveEnd(),
              s.classList && (s.classList.add("boc-cursor-grab"), s.classList.remove("boc-cursor-move"), s.classList.remove("boc-cursor-nodrop"), s.classList.remove("boc-cursor-copy")),
              L(w, k),
              (w = null),
              (k = null),
              ...
              for (; null != n && n != s; ) {
                if (n.hasAttribute && n.hasAttribute(OrgChart.attr.node_id)) {
                  var T = n.getAttribute(OrgChart.attr.node_id);
                  if (i._gragStartedId && T != i._gragStartedId) {
                    (w = T), (k = n);
                    break;
                  }
                }
            ...
            if (null != w) {
              k.classList.add("boc-drag-over");
              for (var B = i.getNode(w), U = OrgChart.getStParentNodes(B), P = 0; P < U.length; P++) {
                var R = i.getNodeElement(U[P].id);
                R && (R.style.opacity = 0.1);
              }
              !i.canUpdateLink(d[0].id, w) && s.classList
                ? (s.classList.remove("boc-cursor-grab"), s.classList.remove("boc-cursor-move"), s.classList.remove("boc-cursor-copy"), s.classList.add("boc-cursor-nodrop"))
                : s.classList && (s.classList.remove("boc-cursor-grab"), s.classList.remove("boc-cursor-move"), s.classList.add("boc-cursor-copy"), s.classList.remove("boc-cursor-nodrop"));
            }
            var F = (r.x - S.x) / I,
              H = (r.y - S.y) / I;
            for (x = 0; x < c.length; x++) {
              (c[x][4] = p[x].x + F), (c[x][5] = p[x].y + H), m[x] && ((m[x][4] = C[x].x + F), (m[x][5] = C[x].y + H)), (d[x].x = g[x].x + F), (d[x].y = g[x].y + H), (d[x].movex = F), (d[x].movey = H);
              var D = OrgChart.ui.link(d[x], i, I, i.response.bordersByRootIdAndLevel, i.nodes, OrgChart.action.update, !0);
              for (P = 0; P < D.length; P++) {
                var z = D[P];
                (j = i.element.querySelector(`[data-l-id="[${z.id}][${z.childId}]"]`)) && (j.innerHTML = z.html);
              }
              if (d[x].parent)
                for (D = OrgChart.ui.link(d[x].parent, i, I, i.response.bordersByRootIdAndLevel, i.nodes, OrgChart.action.update, !0), P = 0; P < D.length; P++) {
                  var j;
                  z = D[P];
                  (j = i.element.querySelector(`[data-l-id="[${z.id}][${z.childId}]"]`)) && (j.innerHTML = z.html);
                }
            }
            if (!t._dragEventFired && (Math.abs(r.x - S.x) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(r.y - S.y) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE)) {
              if ((!1 === OrgChart.events.publish("drag", [i, a, e, o]) && N(), i.config.enableDragDrop)) for (x = 0; x < u.length; x++) s.insertBefore(u[x], s.firstChild);
              t._dragEventFired = !0;
            }
            for (x = 0; x < c.length; x++) u[x].setAttribute("transform", "matrix(" + c[x].toString() + ")"), f[x] && f[x].setAttribute("transform", "matrix(" + m[x].toString() + ")");
          }
        }
      },
      N = function (e) {
        for (var a = 0; a < d.length; a++) (d[a].x = g[a].x), (d[a].y = g[a].y);
        if (
          (i.moveEnd(),
          s.classList && (s.classList.remove("boc-cursor-grab"), s.classList.remove("boc-cursor-move"), s.classList.remove("boc-cursor-nodrop"), s.classList.remove("boc-cursor-copy")),
          s.removeEventListener(r.move, A),
          s.removeEventListener(r.up, N),
          r.leave && s.removeEventListener(r.leave, N),
          d[0].id != w && null != w)
        ) {
          var n = i.getNode(w);
          if (!1 === (l = OrgChart.events.publish("drop", [i, d[0].id, n.id, u[0], e]))) return L(w, k), void (i._gragStartedId = null);
          if (i.canUpdateLink(d[0].id, w)) ((h = i.get(d[0].id)).pid = w), (h.stpid = null), i.updateNode(h, null, !0);
          else L(w, k);
          i._gragStartedId = null;
        } else {
          if (t._dragEventFired) {
            var l = OrgChart.events.publish("drop", [i, d[0].id, void 0, u[0], e]);
            if (i.config.draggable && !1 !== l) {
              for (a = 0; a < d.length; a++) {
                var h;
                if ((h = chart.get(d[a].id))) {
                  var c = OrgChart._getTransform(u[a]);
                  null != h.movex ? (h.movex += c[4] - d[a].x) : (h.movex = c[4] - d[a].x), null != h.movey ? (h.movey += c[5] - d[a].y) : (h.movey = c[5] - d[a].y), chart.update(h);
                }
              }
              chart.draw(OrgChart.action.update, { dragNodeIdList: o });
            }
          }
          i._gragStartedId = null;
        }
      };
    s.addEventListener(r.move, A), s.addEventListener(r.up, N), r.leave && s.addEventListener(r.leave, N);
  }),
  (OrgChart.prototype._dragDropHandler = function (t, e, r) {
    ...
    var s = this,
      ...
      u = s.getScale(),
      f = t.cloneNode(!0);
    f.setAttribute("data-n-id", "draging"), h.insertBefore(f, h.firstChild), (f.style.opacity = 0.7);
    var m = function (t, e) {
        if (null != t) {
          e.classList.remove("boc-drag-over");
      ...
      C = function (e) {
        if (d) {
          ...
          var a = OrgChart._getOffsetXY(s.element, e),
            C = { left: s.width() - (a.x + s.config.padding) < 0, right: a.x - s.config.padding < 0, up: s.height() - (a.y + s.config.padding) < 0, down: a.y - s.config.padding < 0 };
          if (C.left || C.right || C.up || C.down) {
            ...
            s.moveStart(C, function (t) {
              (c[4] = O + t.x), (c[5] = v + t.y), (d.x = y - t.xWithoutScale), (d.y = x - t.yWithoutScale), (r.x = _ - t.xWithoutScale), (r.y = w - t.yWithoutScale), f.setAttribute("transform", "matrix(" + c.toString() + ")");
            });
          } else {
            if (
              (s.moveEnd(),
              h.classList && (h.classList.add("boc-cursor-grab"), h.classList.remove("boc-cursor-move"), h.classList.remove("boc-cursor-nodrop"), h.classList.remove("boc-cursor-copy")),
              m(o, l),
              (o = null),
              (l = null),
            ...
            if (("draging" == o && ((o = null), (l = null)), null != o)) {
              ...
              for (var S = s.getNode(o), I = OrgChart.getStParentNodes(S), L = 0; L < I.length; L++) {
                var A = s.getNodeElement(I[L].id);
                A && (A.style.opacity = 0.1);
              }
              !s.canUpdateLink(n.id, o) && h.classList
                ? (h.classList.remove("boc-cursor-grab"), h.classList.remove("boc-cursor-move"), h.classList.remove("boc-cursor-copy"), h.classList.add("boc-cursor-nodrop"))
                : h.classList && (h.classList.remove("boc-cursor-grab"), h.classList.remove("boc-cursor-move"), h.classList.add("boc-cursor-copy"), h.classList.remove("boc-cursor-nodrop"));
            }
            var N = (r.x - d.x) / u,
              E = (r.y - d.y) / u;
            if (((c[4] = g + N), (c[5] = p + E), !t._dragEventFired && (Math.abs(r.x - d.x) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(r.y - d.y) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE)))
              !1 === OrgChart.events.publish("drag", [s, k, e]) && b(), (t._dragEventFired = !0);
      ...
      b = function (e) {
        if (
          (s.moveEnd(),
          h.classList && (h.classList.remove("boc-cursor-grab"), h.classList.remove("boc-cursor-move"), h.classList.remove("boc-cursor-nodrop"), h.classList.remove("boc-cursor-copy")),
          h.removeEventListener(r.move, C),
          h.removeEventListener(r.up, b),
          r.leave && h.removeEventListener(r.leave, b),
          n.id == o || null == o)
        )
          return t._dragEventFired && OrgChart.events.publish("drop", [s, n.id, void 0, f, e]), h.removeChild(f), void (s._gragStartedId = null);
        var i = s.getNode(o);
        if (!1 === OrgChart.events.publish("drop", [s, n.id, i.id, f, e])) return m(o, l), h.removeChild(f), void (s._gragStartedId = null);
  ...
  (OrgChart.prototype._nodeCircleMenuClickHandler = function (t) {
    OrgChart.SEARCH_CLOSE_RESULT_ON_ESCAPE_OR_CLICKOUTSIDE && this.searchUI.hide(), this.nodeMenuUI.hide(), this.nodeContextMenuUI.hide(), this.menuUI.hide();
    var e = this.getNode(t),
      r = null;
  ...
  (OrgChart.prototype._commonClickHandler = function (t, e, r) {
    var i;
    (OrgChart.SEARCH_CLOSE_RESULT_ON_ESCAPE_OR_CLICKOUTSIDE && this.searchUI.hide(),
  ...
  (OrgChart.prototype._nodeMenuClickHandler = function (t, e, r) {
    OrgChart.SEARCH_CLOSE_RESULT_ON_ESCAPE_OR_CLICKOUTSIDE && this.searchUI.hide(), this.nodeMenuUI.hide(), this.nodeContextMenuUI.hide(), this.menuUI.hide(), this.nodeCircleMenuUI.hide();
    var i = this.getNode(t),
      a = null;
      ...
      if (!this._moveInterval) {
        ...
        OrgChart.isNEU(r) && (r = OrgChart.anim.inSin),
          ...
          (this._moveInterval = setInterval(function () {
            ...
            t.left ? (l++, (d.x = (l * OrgChart.MOVE_STEP) / o), (d.xWithoutScale = l * OrgChart.MOVE_STEP)) : t.right && (l++, (d.x = (-l * OrgChart.MOVE_STEP) / o), (d.xWithoutScale = -l * OrgChart.MOVE_STEP)),
              t.up ? (s++, (d.y = (s * OrgChart.MOVE_STEP) / o), (d.yWithoutScale = s * OrgChart.MOVE_STEP)) : t.down && (s++, (d.y = (-s * OrgChart.MOVE_STEP) / o), (d.yWithoutScale = -s * OrgChart.MOVE_STEP));
            var c = r((10 * h - 10) / i);
            (d.x = d.x * c), (d.xWithoutScale = d.xWithoutScale * c), (d.y = d.y * c), (d.yWithoutScale = d.yWithoutScale * c), a.setViewBox([n[0] + d.x, n[1] + d.y, n[2], n[3]]), e && e(d), (h += 1);
          }, 10));
      }
  ...
  (OrgChart.prototype._mouseDownHandler = function (t, e, r) {
    ...
    e.touches && e.touches.length > 1 && ((s.type = "pinch"), (s.dist = Math.sqrt((o.x - l.x) * (o.x - l.x) + (o.y - l.y) * (o.y - l.y)))), "pan" == s.type && (this._hideBeforeAnimation(), this._changeCursorOnPanStart(a, n, e));
    var h = function (t) {
    ...
    this.config.enablePan && (t.addEventListener(r.move, h), t.addEventListener(r.up, d), r.leave && t.addEventListener(r.leave, d), r.touchstart && t.addEventListener(r.touchstart, d));
  }),
  (OrgChart.prototype._changeCursorOnPanStart = function (t, e, r) {
    ...
    (i.style.display = "inherit"),
      ...
      OrgChart.animate(i, { transform: [0, 0, 0, 0, n, o], opacity: 0 }, { transform: [1 / e, 0, 0, 1 / e, n, o], opacity: 1 }, 300, OrgChart.anim.outBack);
  }),
  (OrgChart.prototype._changeCursorOnPanEnd = function () {
    this.getPointerElement().style.display = "none";
  }),
  (OrgChart.searchUI = function () {
    (this.lastSearch = []), (this._searchAfterEnterPress = !1), (this._event_id = OrgChart._guid()), (this.instance = null);
  }),
  (OrgChart.searchUI.prototype.init = function (t) {
    ...
    l.classList.add("boc-search"), (l.style.right = r + "px"), (l.style.top = i + "px");
    var s = OrgChart.elements.textbox({}, { label: OrgChart.SEARCH_PLACEHOLDER, btn: "X" }, "320px");
    ...
    this.instance.element.insertBefore(l, h),
      ...
      this.input.addEventListener("blur", function (t) {
        OrgChart.isNEU(e.input.value) && OrgChart.SEARCH_HELP_SYMBOL != e.input.value && (e.xBtn.style.display = "none");
      }),
      ...
      this.input.addEventListener("keyup", function (t) {
        "ArrowDown" == t.key ? d() : "ArrowUp" == t.key ? c() : "Enter" == t.key ? e._enterHandler() : "Escape" == t.key ? e.hide() : e._search();
      });
    var d = function () {
      ...
      c = function () {
        ...
        null == r && t.length > 0
          ...
          : t.length > 0 && r.previousSibling && r.previousSibling.setAttribute && (r.removeAttribute("data-selected"), r.previousSibling.setAttribute("data-selected", "yes"));
      };
  }),
  (OrgChart.searchUI.prototype._enterHandler = function () {
    ...
    if (t) {
      if (t.hasAttribute("data-search-item-id")) {
        ...
        } else (this.input.value = e + " "), (this.searchTableWrapper.innerHTML = "");
      }
  ...
  (OrgChart.searchUI.prototype._initSearchFields = function () {
    if (null == this.instance.config.searchFields) {
      ...
      for (var t = 0; t < this.instance.response.allFields.length; t++) {
        ...
        "tags" == e || OrgChart._fieldIsImg(this.instance.config, e) || this._searchFields.push(e);
      }
  ...
  (OrgChart.searchUI.prototype.find = function (t) {
    this.input && ((this.input.value = t), document.activeElement == this.input ? this._search(t) : this.input.focus());
  }),
  (OrgChart.searchUI.prototype.addMatchTag = function (t) {
    if (this._searchAfterEnterPress) {
      for (var e = 0; e < this.lastSearch.length; e++) if (this.lastSearch[e].id == t) return !0;
      return !1;
    }
    return null;
  }),
  ...
  (OrgChart.searchUI.prototype._search = function () {
    var t,
      e = this;
    if (((this._searchAfterEnterPress = !1), this.input.value == OrgChart.SEARCH_HELP_SYMBOL)) t = this.helpView();
    else {
      this.__search();
      var r = OrgChart._getFistImgField(this.instance.config);
      t = `<table border="0" cellspacing="0" cellpadding="0">\n                        <tbody>\n                            ${(function () {
        for (var t = "", i = 0; i < e.lastSearch.length && !(i >= OrgChart.SEARCH_RESULT_LIMIT); i++) {
          var a = e.lastSearch[i],
            n = "";
          if (r) {
            var o = e.instance._get(a.id);
            "function" == typeof r ? (n = r(e.instance, e.instance.getNode(a.id), o)) : o[r] && (n = o[r]);
          }
          var l = "",
            s = "";
          e.instance.config.searchDisplayField == a.__searchField
            ...
            ? ((l = a[e.instance.config.searchDisplayField]), OrgChart.isNEU(l) && (l = ""), (s = a.__searchMarks))
            : (l = a.__searchMarks);
          var h = { img: n, nodeId: a.id, first: l, second: s, searchItem: a, html: OrgChart.searchUI.createItem(n, a.id, l, s) };
    ...
    for (var i = this.instance.element.querySelectorAll("[data-search-item-id]"), a = 0; a < i.length; a++)
        ...
        if (this.hasAttribute("data-search-item-id")) {
          ...
          if (e.input.value != OrgChart.SEARCH_HELP_SYMBOL) {
            ...
            if ((!1 === r && (i = !1), !1 !== i)) {
              ...
              a && a.removeAttribute("data-selected"), this.setAttribute("data-selected", "yes"), e.input.focus();
            }
          } else (e.input.value = t + " "), (e.searchTableWrapper.innerHTML = ""), e.input.focus();
        }
      });
  ...
  (OrgChart.searchUI.createItem = function (t, e, r, i) {
    return (
      ...
      `<tr data-search-item-id="${e}">\n                <td class="boc-search-image-td">\n                    ${(t = t
        ...
        : `<div class="boc-search-photo">${OrgChart.icon.user(32, 32, "#aeaeae")}</div>`)}\n                </td>\n                <td class="boc-search-text-td">${r} <br/>${i}</td>\n            </tr>`
    );
  }),
  (OrgChart.searchUI.prototype.hide = function () {
    if (!1 === OrgChart.events.publish("hide", [this])) return !1;
    this._searchAfterEnterPress && ((this._searchAfterEnterPress = !1), this.instance.draw()),
      (this.lastSearch = []),
      this.xBtn && (this.xBtn.style.display = "none"),
      this.searchTableWrapper && (this.searchTableWrapper.innerHTML = ""),
      this.input && ((this.input.value = ""), document.activeElement == this.input && this.input.blur(), document.activeElement == this.xBtn && OrgChart.input.blurHandler(this.input));
  }),
  ...
  (OrgChart.manager.prototype.read = function (t, e, r, i, a, n, o, l) {
    ...
    OrgChart.state._get(this.config.state, e, r, function (h) {
      (s.state = h),
        (s.action = a),
        (s.actionParams = n),
        a != OrgChart.action.init || !s.state || (n && n.method && "fit" == n.method)
      ...
      if (t) {
        ...
        a != OrgChart.action.exporting && ((s.maxX = d), (s.maxY = c), (s.minX = g), (s.minY = p), (s.roots = f), (s.nodes = m), (s.visibleNodeIds = C.visibleNodeIds)),
        ...
        (s.oldNodes = m || null),
          s._read(function (t) {
            ...
            (i.notif = t.limit),
              ...
              a != OrgChart.action.exporting && ((s.maxX = d), (s.maxY = c), (s.minX = g), (s.minY = p), (s.roots = f), (s.nodes = m), (s.visibleNodeIds = i.visibleNodeIds), (s.bordersByRootIdAndLevel = u), (s.rootList = t.rootList)),
              o(i);
          }, l);
    });
  }),
    ...
    null == o && (o = OrgChart.local),
      o._setPositions(
        ...
        function (e) {
          ...
          r.state && r.action == OrgChart.action.init && (o = r.state.adjustify), r.action == OrgChart.action.exporting ? (o = r._fixAdjustForExport) : (r._fixAdjustForExport = o);
          for (var l = { minX: null, minY: null, maxX: null, maxY: null }, s = {}, h = 0; h < n.length; h++) OrgChart.manager._setMinMaxXYAdjustifyIterate(n[h], n[h], l, 0, s, o, r.config.orientation);
          t({ minX: l.minX, minY: l.minY, maxX: l.maxX, maxY: l.maxY, bordersByRootIdAndLevel: s, nodes: a, roots: n, rootList: i.rootList, limit: e, adjustify: o });
        },
        a
      );
  }),
  ...
  (OrgChart.manager._initDinamicNode = function (t, e, r) {
    ...
    (t.w = i && i.size ? i.size[0] : 0), (t.h = i && i.size ? i.size[1] : 0), (t.isSplit = "split" == t.templateName), (t.isMirror = "mirror" == t.templateName), (t.isSubLevel = "subLevel" == t.templateName);
  }),
    ...
    null == t.collapsed && e.collapse && e.collapse.allChildren ? (t.collapsed = !0) : null == t.collapsed && (t.collapsed = !1),
      ...
      a == OrgChart.action.collapse && (r.expandIds || r.collapseIds)
        ? r.expandIds && -1 != r.expandIds.indexOf(t.id)
          ? (t.collapsed = !1)
          : r.collapseIds && -1 != r.collapseIds.indexOf(t.id) && (t.collapsed = !0)
        : a == OrgChart.action.collapse && -1 != r.ids.indexOf(t.id) && (t.collapsed = !0),
      ...
      a == OrgChart.action.init && null != o
        ...
        ? (t.collapsed = e.collapse && n >= e.collapse.level - 1 && -1 == i.indexOf(t.id))
        : a == OrgChart.action.centerNode || a == OrgChart.action.insert || a == OrgChart.action.expand || a == OrgChart.action.collapse
        ? i.has(t.id) && (t.collapsed = !1)
        : a == OrgChart.action.update && r && r.changeRoots && r.changeRoots.has(t.id) && (t.collapsed = !1);
  }),
  (OrgChart.manager._initNode = function (t, e, r, i, a, n, o) {
    var l = o.manager.config,
      ...
      c = o.manager.state,
      g = s[r || "base"];
    null == t.parent && OrgChart.manager._setCollpasedProperty(t, g, d, a, h, i - 1, c);
    for (var p = 0; p < t.childrenIds.length; p++) {
      var u = e[t.childrenIds[p]];
      if ((OrgChart.manager._setCollpasedProperty(u, g, d, a, h, i, c), !u.collapsed)) {
    ...
    if (
      ...
      for (p = 0; p < t.stChildrenIds.length; p++) {
        ...
        (t.tags && t.tags.has("filter")) || ((u.stParent = t), t.stChildren.push(u));
      }
  ...
  (OrgChart.manager._iterate = function (t, e, r, i, a, n, o, l, s, h, d, c) {
    ...
    if (
      ...
      if (e.parent && e.parent.children.length && e.parent.children[e.parent.children.length - 1] == e) {
        for (var p = [], u = 0, f = 0, m = 0; m < e.parent.children.length; m++) {
          -1 == (C = e.parent.children[m]).tags.indexOf("partner") && -1 == C.tags.indexOf("left-partner") && -1 == C.tags.indexOf("right-partner") && -1 == C.tags.indexOf("assistant") && 0 == C.children.length
            ? p.push(C.id)
            : -1 != C.tags.indexOf("assistant")
            ? u++
            : (-1 == C.tags.indexOf("partner") && -1 == C.tags.indexOf("left-partner") && -1 == C.tags.indexOf("right-partner")) || f++;
        }
      ...
      for (p = [], u = 0, f = 0, m = 0; m < e.parent.children.length; m++) {
        var C;
        -1 == (C = e.parent.children[m]).tags.indexOf("partner") && -1 == C.tags.indexOf("left-partner") && -1 == C.tags.indexOf("right-partner") && -1 == C.tags.indexOf("assistant") && 0 == C.childrenIds.length
          ? p.push(C.id)
          : -1 != C.tags.indexOf("assistant")
          ? u++
          : (-1 == C.tags.indexOf("partner") && -1 == C.tags.indexOf("left-partner") && -1 == C.tags.indexOf("right-partner")) || f++;
      }
      ((OrgChart.MIXED_LAYOUT_ALL_NODES && p.length > OrgChart.MIXED_LAYOUT_IF_NUMBER_OF_CHILDREN_IS_MORE_THEN && p.length == e.parent.childrenIds.length - u - f) ||
        (!OrgChart.MIXED_LAYOUT_ALL_NODES && p.length > OrgChart.MIXED_LAYOUT_IF_NUMBER_OF_CHILDREN_IS_MORE_THEN)) &&
        (l[e.pid] = p);
    }
    ...
    for (var b = 0; b < e.stChildren.length; b++) {
      ...
      a.push(e.stChildren[b].id), OrgChart.manager._iterate(t, e.stChildren[b], r, 0, a, n, o, l, O, h, d, c);
    }
    i++;
    for (b = 0; b < e.children.length; b++) OrgChart.manager._iterate(t, e.children[b], r, i, a, n, o, l, s, h, d, c);
  }),
  (OrgChart.manager.__createNodes = function (t, e, r, i, a, n, o, l) {
    for (var s = [], h = OrgChart._addDottedLines(r), d = 0; d < h.length; d++) {
      var c,
        g = h[d];
      (c = OrgChart.STRING_TAGS ? (g.tags ? g.tags.split(",") : []) : Array.isArray(g.tags) ? g.tags.slice(0) : []), l.filterUI.addFilterTag(g) && c.unshift("filter");
      ...
      OrgChart.isNEU(g.ppid) || (f.ppid = g.ppid),
        ...
        null != r.orderBy && (f.order = OrgChart.manager._getOrderFieldValue(g, r.orderBy)),
    ...
    null != r.orderBy &&
      s.sort(function (e, i) {
        ...
        return "number" == typeof a || "number" == typeof n
          ? (null == a && (a = -1), null == n && (n = -1), r.orderBy.desc ? n - a : a - n)
          : "string" == typeof a || "string" == typeof n
          ? (null == a && (a = ""), null == n && (n = ""), r.orderBy.desc ? n.localeCompare(a) : a.localeCompare(n))
          : void 0;
      });
    for (d = 0; d < s.length; d++) {
      var m = s[d],
        ...
        b = t[f.stpid],
        O = t[f.pid];
      if ((b || (f.stpid = null), O || (f.pid = null), b)) {
        var v = n ? n[b.id] : null;
        v && (b.min = v.min), b.stChildrenIds.push(f.id);
      } else O ? (C && ((f.collapsed = C.collapsed), (f.min = C.min)), O.childrenIds.push(f.id)) : (C && ((f.collapsed = C.collapsed), (f.min = C.min)), e.push(f), o.push(f.id));
  ...
  (OrgChart.manager._createNodes = function (t) {
    ...
    if ((OrgChart.manager.__createNodes(l, s, e, i, a, n, h, t), null != e.roots)) {
      ...
      for (var d = 0; d < e.roots.length; d++) {
        ...
        if (c && i == OrgChart.action.centerNode) {
          for (var g = c; null != g.pid || null != g.stpid; ) g = null == g.pid && null != g.stpid ? l[g.stpid] : l[g.pid];
          for (var p = l[a.id]; (null != p.pid || null != p.stpid) && p != c; ) p = null == p.pid && null != p.stpid ? l[p.stpid] : l[p.pid];
          g == p && (c = g);
        }
        if (c) {
          ...
          if (!u) {
            if (!OrgChart.isNEU(c.pid)) (ft = (b = l[c.pid]).childrenIds.indexOf(c.id)) > -1 && b.childrenIds.splice(ft, 1);
            s.push(c);
          }
        }
      }
    ...
    if (i == OrgChart.action.init && e.expand && e.expand.nodes && null == o)
      ...
      for (d = 0; d < it.length; d++) for (var b = l[(C = l[it[d]]).pid]; b; ) m.push(b.id), null == b.pid && null != b.stpid ? ((b = l[b.stpid]).min = !1) : (b = l[b.pid]);
    } else if (i == OrgChart.action.centerNode) {
      for (var O = l[a.id]; O; ) {
        if ((m.push(O.id), a.options.parentState === OrgChart.COLLAPSE_PARENT_NEIGHBORS && O))
          for (d = 0; d < O.childrenIds.length; d++) {
            (H = l[O.childrenIds[d]]).collapsed = !0;
          }
        null == O.pid && null != O.stpid ? ((O = l[O.stpid]).min = !1) : (O = l[O.pid]);
      }
      O = l[a.id];
      if (a.options.childrenState === OrgChart.COLLAPSE_SUB_CHILDRENS)
        for (d = 0; d < O.childrenIds.length; d++) {
          (y = l[O.childrenIds[d]]).collapsed = !1;
          for (var v = 0; v < y.childrenIds.length; v++) {
            l[y.childrenIds[v]].collapsed = !0;
          }
        }
      if (a.options.parentState === OrgChart.COLLAPSE_PARENT_SUB_CHILDREN_EXCEPT_CLICKED)
        if ((b = l[O.pid]))
          for (d = 0; d < b.childrenIds.length; d++) {
            var y;
            if ((y = l[b.childrenIds[d]]) != O) {
              y.collapsed = !1;
    ...
    var x = [],
      ...
      k = {},
      S = [];
    for (d = 0; d < s.length; d++) OrgChart.manager._iterate(s[d], s[d], l, 0, x, _, w, k, "", m, S, t);
    if (i == OrgChart.action.collapse && a && Array.isArray(a.expandIds) && Array.isArray(a.collapseIds))
      for (d = 0; d < a.ids.length; d++) {
        if (a.expandIds.has(a.collapseIds[d])) console.error(`id ${a.collapseIds[d]} exist in both collapseIds and expandIds`);
    ...
    for (d = 0; d < S.length; d++) {
      ...
      for (v = 0; v < C.children.length; v++) {
        (H = C.children[v]).isAssistant
          ...
          ? ((H.isPartner = 1), (H.children = []), L.push(H.id))
          : -1 != H.tags.indexOf("left-partner")
          ? ((H.isPartner = 2), (H.children = []), A.push(H.id))
          : -1 == H.tags.indexOf("partner") || E % 2
          ? -1 != H.tags.indexOf("partner") && E % 2
            ? ((H.isPartner = 2), (H.children = []), A.push(H.id), E++)
            : H.parentPartner
            ? (N[H.parentPartner.id] || (N[H.parentPartner.id] = []), N[H.parentPartner.id].push(H.id))
            : I.push(H.id)
          : ((H.isPartner = 1), (H.children = []), L.push(H.id), E++);
      }
      C.children = [];
      var P = [];
      for (v = 0; v < L.length; v++) {
        N[(H = l[L[v]]).id] ? C.children.push(H) : C.children.splice(0, 0, H);
        for (var R = 0; R < H.childrenIds.length; R++) P.push(H.childrenIds[R]);
      }
      var F = [];
      for (v = 0; v < A.length; v++) {
        N[(H = l[A[v]]).id] ? C.children.push(H) : C.children.splice(0, 0, H);
        for (R = 0; R < H.childrenIds.length; R++) F.push(H.childrenIds[R]);
      }
      for (v = 0; v < F.length; v++) {
        (H = l[F[v]]).collapsed || ((H.parentPartner = H.parent), (H.parent = C), (H.isChildOfPartner = !0), C.children.push(H));
      }
      for (v = A.length - 1; v >= 0; v--) if (N[A[v]]) for (f = 0; f < N[A[v]].length; f++) C.children.push(l[N[A[v]][f]]), M++, -1 == U.indexOf(A[v]) && U.push(A[v]);
      for (v = 0; v < I.length; v++) {
        var H = l[I[v]];
        C.children.push(H);
      }
      for (v = 0; v < L.length; v++) if (N[L[v]]) for (f = 0; f < N[L[v]].length; f++) C.children.push(l[N[L[v]][f]]), T++, -1 == B.indexOf(L[v]) && B.push(L[v]);
      for (v = 0; v < P.length; v++) {
        (H = l[P[v]]).collapsed || ((H.parentPartner = H.parent), (H.parent = C), (H.isChildOfPartner = !0), C.children.push(H));
      }
      (C.partnerSeparation = Math.max(U.length, B.length) * e.partnerChildrenSplitSeparation + e.minPartnerSeparation),
        I.length || !M || T
          ? I.length || M || !T
            ? I.length || 1 != M || 1 != T
              ? I.length || M || T
    ...
    for (d = 0; d < w.length; d++) {
      ...
      for (v = 0; v < C.subLevels; v++) {
        var z = new OrgChart.node(C.id + "_sub_level_index_" + v, C.pid, [], "subLevel");
        if ((OrgChart.manager._initDinamicNode(z, C.lcn), (b = C.parent))) (ft = b.children.indexOf(C)) > -1 && (b.children.splice(ft, 1), b.children.splice(ft, 0, z)), z.children.push(C), (z.parent = b), (C.parent = z), (l[z.id] = z);
      }
    }
    for (var j in _) {
      (b = l[j]).hasAssistants = !0;
      z = new OrgChart.node(b.id + "_split_assitant_0", b.id, ["assistant"], "split");
      OrgChart.manager._initDinamicNode(z, b.lcn, !0), (l[z.id] = z);
      var q = [];
      for (v = b.children.length - 1; v >= 0; v--) {
        (H = b.children[v]).isAssistant
          ? ((H.parent = null), b.children.splice(v, 1), q.splice(0, 0, H.id))
          : H.isPartner ||
            (H.parent && k[H.parent.id] && z && H.parent.id != z.id && (Object.defineProperty(k, z.id, Object.getOwnPropertyDescriptor(k, H.parent.id)), delete k[H.parent.id]),
            (H.parent = z),
            z.children.unshift(H),
            b.children.splice(v, 1));
      }
      if (q.length % 2) {
        var Y = l[q[q.length - 1]],
          X = new OrgChart.node(Y.id + "_mirror", b.pid, [], "mirror");
        OrgChart.manager._initDinamicNode(X, Y.lcn, !0), (X.isAssistant = !0), (X.w = Y.w), (X.h = Y.h), (l[X.id] = X), q.splice(q.length - 1, 0, X.id);
      }
      var $ = 1;
      for (v = q.length - 1; v >= 0; v--)
        if (v % 2 && v != q.length - 1) {
          var V = new OrgChart.node(b.id + "_split_assitant_" + $, b.pid, [], "split");
          OrgChart.manager._initDinamicNode(V, b.lcn, !0), (l[V.id] = V), q.splice(v, 0, V.id), $++;
        } else v % 2 && q.splice(v, 0, z.id);
      for (v = 0; v < q.length; v += 3) {
        var G = null;
        G = 0 == v ? b : l[q[v - 2]];
        var W = l[q[v]],
          J = l[q[v + 1]],
          K = l[q[v + 2]];
        (W.parent = G), (J.parent = G), (K.parent = G), G.children.push(W), G.children.push(J), G.children.push(K);
      }
    }
    var Z = !1;
    for (var Q in r) {
      ...
      if (w.length) {
        ...
        if (rt) {
          ...
          for (var j in k) {
            ...
            for (d = 0; d < it.length; d++) {
              var ht = it[d];
              (null === st || w.has(ht)) && ((st = l[ht].parent.id), lt || OrgChart.isNEU(l[ht].subLevels) || (lt = l[ht].subLevels > 0)),
                at[st] || (at[st] = []),
                at[st].push(ht),
          ...
          for (var j in ((k = {}), nt))
            if (nt[j].length > OrgChart.MIXED_LAYOUT_IF_NUMBER_OF_CHILDREN_IS_MORE_THEN) {
              var dt = ot[j];
          ...
          for (var j in at) at[j].length > OrgChart.MIXED_LAYOUT_IF_NUMBER_OF_CHILDREN_IS_MORE_THEN && (k[j] = at[j]);
        }
      }
      for (var j in k) {
        for (var ct = (b = l[j]); ct.isSplit; ) ct = l[ct.pid];
        for (; ct.isSubLevel; ) ct = l[ct.pid];
        if ((D = r[b.lcn ? b.lcn : "base"]).layout > 0 || tt) {
          (et.pnode = b),
            (et.layout = D.layout),
            (et.childrenIds = k[j]),
            ...
            et.layouts.length || et.layouts.push({ layout: et.layout, childrenIds: et.childrenIds, subLevels: et.subLevels });
          for (var gt = 0; gt < et.layouts.length; gt++) {
            var pt = et.layouts[gt];
            for (OrgChart.isNEU(pt.subLevels) && (pt.subLevels = 0), OrgChart.isNEU(pt.layout) && (pt.layout = D.layout), ct = b = l[j]; ct.isSplit; ) ct = l[ct.pid];
            for (; ct.isSubLevel; ) ct = l[ct.pid];
            var ut = b;
            for (v = 0; v < pt.subLevels; v++) {
              z = new OrgChart.node(gt + "_sublevel_layout_" + v, ut.id, [], "subLevel");
              OrgChart.manager._initDinamicNode(z, ut.lcn), (z.parent = ut), ut.children.push(z), (l[z.id] = z), (ut = z);
            }
            if (pt.subLevels) {
              for (v = 0; v < pt.childrenIds.length; v++) {
                var ft;
                H = l[pt.childrenIds[v]];
                -1 != (ft = b.children.indexOf(H)) && b.children.splice(ft, 1), (H.parent = ut), ut.children.push(H);
              }
              b = ut;
            }
            if (pt.layout == OrgChart.layout.mixed) {
              var mt = pt.childrenIds;
              for (d = mt.length - 1; d >= 0; d--) {
                (b = (H = l[mt[d]]).parent), (H.layout = OrgChart.layout.mixed);
                for (v = b.children.length - 1; v >= 0; v--)
                  if (H.id == b.children[v].id) {
                    b.children.splice(v, 1);
                    break;
                  }
                if (d > 0) {
                  var Ct = l[mt[d - 1]];
                  (H.parent = Ct), (H.layout = OrgChart.layout.mixed), Ct.children.push(H);
                } else b.children.push(H);
              }
            } else if (pt.layout > 1) {
              z = new OrgChart.node(gt + "_" + b.id + "_split_0", ct.id, [], "split");
              OrgChart.manager._initDinamicNode(z, b.lcn), (l[z.id] = z), (z.layout = pt.layout);
              var bt = [];
              for (d = pt.childrenIds.length - 1; d >= 0; d--) {
                for (H = l[pt.childrenIds[d]], v = 0; v < b.children.length; v++) b.children[v].id == H.id && b.children.splice(v, 1);
                if (((H.parent = null), (H.layout = pt.layout), (pt.layout != OrgChart.layout.treeRightOffset && pt.layout != OrgChart.layout.treeRight) || bt.splice(0, 0, H.id), pt.layout > 2)) {
                  var Ot = new OrgChart.node(gt + "_" + H.id + "_mirror", ct.id, [], "mirror");
                  OrgChart.manager._initDinamicNode(Ot, H.lcn), (Ot.layout = pt.layout), (l[Ot.id] = Ot), bt.splice(0, 0, Ot.id);
                }
                pt.layout != OrgChart.layout.treeRightOffset && pt.layout != OrgChart.layout.treeRight && bt.splice(0, 0, H.id);
              }
              for ($ = 1, v = bt.length - 1; v >= 0; v--)
                if (v % 2 && v != bt.length - 1) {
                  V = new OrgChart.node(gt + "_" + b.id + "_split_" + $, ct.id, [], "split");
                  OrgChart.manager._initDinamicNode(V, b.lcn), (V.layout = pt.layout), (l[V.id] = V), bt.splice(v, 0, V.id), $++;
                } else v % 2 && bt.splice(v, 0, z.id);
              for (v = 0; v < bt.length; v += 3) {
                G = null;
                0 == v && (G = b);
                (W = l[bt[v]]), (J = l[bt[v + 1]]), (K = l[bt[v + 2]]);
                0 != v && (G = l[bt[v - 3]]),
                  0 == v || J || (G = l[bt[v - 2]]),
                  (W.parent = G),
                  G.children.push(W),
                  J && (0 != v && (G = l[bt[v - 2]]), (J.parent = G), G.children.push(J)),
                  K && (0 != v && (G = l[bt[v - 1]]), (K.parent = G), G.children.push(K));
              }
            }
          }
        }
    ...
    if (OrgChart.VERTICAL_CHILDREN_ASSISTANT) for (d = 0; d < s.length; d++) OrgChart.manager._verticalAssistantIterate(s[d], l);
    et = { nodes: l, roots: s };
    return OrgChart.events.publish("nodes-initialized", [t, et]), { nodes: et.nodes, roots: et.roots, rootList: h };
  }),
  ...
  (OrgChart.manager.getAllFields = function (t) {
    ...
    for (r = 0; r < t.nodes.length; r++)
      for (var i in t.nodes[r]) i !== OrgChart.ID && i !== OrgChart.TAGS && i !== OrgChart.NODES && i !== OrgChart.PID && i !== OrgChart.STPID && "movex" !== i && "movey" !== i && (t.nodeBinding[i] || e.has(i) || e.push(i));
    return e;
  }),
  ...
  (OrgChart.manager._getResponse = function (t, e, r, i, a, n, o, l, s, h, d, c, g, p, u) {
    ...
    if (
      ...
      if (x - 2 * i.padding >= a - o)
        ...
        switch (((w = f.x - x / 2 + OrgChart.manager._getNodeWidth(f, i) / 2), i.orientation)) {
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
      ...
      if (_ - 2 * i.padding >= n - l)
        ...
        switch (((k = -(_ / 2 - (n - l) / 2)) > -i.padding && (k = -i.padding), i.orientation)) {
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
      ...
      switch (i.orientation) {
        case OrgChart.orientation.top:
          (w = f.x - x / 2 + OrgChart.manager._getNodeWidth(f, i) / 2), (k = -i.padding);
          break;
        case OrgChart.orientation.bottom:
          (w = f.x - x / 2 + OrgChart.manager._getNodeWidth(f, i) / 2), (k = i.padding - _);
          break;
        case OrgChart.orientation.left:
          (w = -i.padding), (k = f.y - _ / 2 + OrgChart.manager._getNodeWidth(f, i) / 2);
          break;
        case OrgChart.orientation.right:
          (w = i.padding - x), (k = f.y - _ / 2 + OrgChart.manager._getNodeWidth(f, i) / 2);
          break;
        case OrgChart.orientation.top_left:
      ...
      (s = [w, k, x, _]),
        i.sticky &&
          (s[0] < C.left && s[0] < C.right && (s[0] = C.left > C.right ? C.right : C.left),
    ...
    if (d == OrgChart.action.insert || d == OrgChart.action.expand || d == OrgChart.action.collapse || d == OrgChart.action.update || d == OrgChart.action.centerNode || d == OrgChart.action.maximize) {
      ...
      if (!OrgChart.FIXED_POSITION_ON_CLICK && I)
        switch (i.orientation) {
          ...
          case OrgChart.orientation.left:
          case OrgChart.orientation.left_top:
            L = I.x + I.w - s[2] + i.padding;
            s[0] < L && (s[0] = L);
        }
    }
    for (var A = 0; A < h.length; A++) OrgChart.manager._iterate2(h[A], g, i, s, d, c, m, p, r, b);
    return { animations: b, boundary: C, viewBox: s, visibleNodeIds: m, nodes: g, allFields: OrgChart.manager.getAllFields(i) };
  }),
  (OrgChart.manager._iterate2 = function (t, e, r, i, a, n, o, l, s, h) {
    if (OrgChart.manager._isVisible(t, r, i, a)) {
      ...
      if ((a == OrgChart.action.expand || a == OrgChart.action.collapse || a == OrgChart.action.maximize) && l && l[t.id] && "expandCollapseToLevel" == n.method) {
        ...
        if ((null != (u = l[t.id]).x && null != u.y && (d = { x: u.x, y: u.y }), (p = e[n.id]) && p == t)) (c = t.parent) && c.id == n.id && (d = { x: p.x + p.w / 2 - t.w / 2, y: p.y + p.h / 2 - t.h / 2 });
      } else if (a == OrgChart.action.maximize && l && l[t.id]) {
        var p;
        if ((null != (u = l[t.id]).x && null != u.y && (d = { x: u.x, y: u.y }), (p = e[n.id]) && p == t)) (c = t.parent) && c.id == n.id && (d = { x: p.x + p.w / 2 - t.w / 2, y: p.y + p.h / 2 - t.h / 2 });
      } else if (a == OrgChart.action.minimize && l && l[t.id]) {
        d = { x: (u = l[t.id]).x, y: u.y };
      } else if (a == OrgChart.action.insert && n && n.insertedNodeId == t.id && t.parent) d = { x: t.parent.x, y: t.parent.y };
      else if ((a != OrgChart.action.update && a != OrgChart.action.insert) || !l)
        a !== OrgChart.action.exporting && a !== OrgChart.action.init && -1 == s.indexOf(t.id) && (h[0].push(t.id), h[1].push({ opacity: 0 }), h[2].push({ opacity: 1 }));
      else {
        var u, f;
      ...
      if (null != d && null != d.x && null != d.y)
        if (d.x != t.x || d.y != t.y) (n && n.dragNodeIdList && -1 != n.dragNodeIdList.indexOf(t.id)) || (h[0].push(t.id), h[1].push({ transform: [1, 0, 0, 1, d.x, d.y] }), h[2].push({ transform: [1, 0, 0, 1, t.x, t.y] }));
    }
  ...
  (OrgChart.manager._setMinMaxXYAdjustifyIterate = function (t, e, r, i, a, n, o) {
    ...
    t.isPartner ? (t.sl = i - 1) : (t.sl = i),
      null == a[e.id] && (a[e.id] = {}),
      null == a[e.id][t.sl] && (a[e.id][t.sl] = { minX: null, minY: null, maxX: null, maxY: null }),
  ...
  (OrgChart.manager._verticalAssistantIterate = function (t, e) {
    for (var r = 0; r < t.stChildren.length; r++) OrgChart.manager._verticalAssistantIterate(t.stChildren[r], e);
    if (3 == t.children.length) OrgChart.manager._verticalAssistantIterate(t.children[0], e), OrgChart.manager._verticalAssistantIterate(t.children[2], e), OrgChart.manager._verticalAssistantIterate(t.children[1], e);
    else for (r = 0; r < t.children.length; r++) OrgChart.manager._verticalAssistantIterate(t.children[r], e);
    if (t.isAssistant && t.isSplit && t.children.length) {
      for (var i = t.parent.children[0], a = t.parent.children[2], n = t.parent; !n.hasAssistants; ) n = n.parent;
      var o = { max: 0 },
        l = { max: 0 };
      OrgChart.manager._verticalAssistantLevelCountIterate(i, 0, o), OrgChart.manager._verticalAssistantLevelCountIterate(a, 0, l);
      var s = Math.max(o.max, l.max),
        h = [];
      for (r = 0; r < s; r++) {
        var d = new OrgChart.node(t.parent.id + "_split_assitant_level_" + r, t.pid, [], "subLevel");
        OrgChart.manager._initDinamicNode(d, t.lcn, !0), r > 0 && (h[r - 1].children.push(d), (d.parent = h[r - 1])), (e[d.id] = d), h.push(d);
      }
      if (h.length) {
        for (var c = h[h.length - 1], g = h[0], p = t.children.length - 1; p >= 0; p--) {
          var u = t.children[p];
  ...
  (OrgChart.manager._verticalAssistantLevelCountIterate = function (t, e, r) {
    r.max < e && (r.max = e), e++;
    for (var i = 0; i < t.children.length; i++) OrgChart.manager._verticalAssistantLevelCountIterate(t.children[i], e, r);
  }),
  (OrgChart._addDottedLines = function (t) {
    var e = t.nodes;
    if (((t.groupDottedLines.length || t.dottedLines.length) && (e = JSON.parse(JSON.stringify(e))), t.groupDottedLines.length))
      for (var r = [], i = 0; i < t.groupDottedLines.length; i++) {
        ...
        if (!r.has(n))
          for (var o = 0; o < e.length; o++)
            if (e[o].id == a.rootId) {
              ((d = JSON.parse(JSON.stringify(e[o]))).id = `balkan_group_dotted_${a.rootId}_balkan_id_${e[o].id}`),
                (d.pid = void 0),
                (d.stpid = e[o].id),
                e.push(d),
                r.push(n),
        ...
        for (o = 0; o < e.length; o++)
          if (e[o].id == a.from) {
            if ((((d = JSON.parse(JSON.stringify(e[o]))).id = `balkan_group_dotted_${a.rootId}_balkan_id_${e[o].id}`), (d.pid = `balkan_group_dotted_${a.rootId}_balkan_id_${a.to}`), d.tags)) {
              var l = d.tags.indexOf("group-dotted-lines");
              -1 != l && d.tags.splice(l, 1);
            }
            if ((d.tags || (d.tags = []), d.tags.push("boc-dotted-connector"), a.tags)) for (var s = 0; s < a.tags.length; s++) d.tags.push(a.tags[s]);
            e.push(d);
            break;
          }
      }
      ...
      for (i = 0; i < t.dottedLines.length; i++) {
        ...
        for (o = 0; o < e.length; o++)
          if (e[o].id == h.from) {
            var d;
            if (
              (((d = JSON.parse(JSON.stringify(e[o]))).id = `balkan_dotted_${h.rootId}_balkan_id_${e[o].id}`),
              h.rootId == h.to ? (d.pid = h.to) : (d.pid = `balkan_dotted_${h.rootId}_balkan_id_${h.to}`),
              d.tags || (d.tags = []),
  ...
  (OrgChart.templates.group_dotted_lines = Object.assign({}, OrgChart.templates.group)),
  (OrgChart.templates.group_dotted_lines.size = [250, 120]),
  (OrgChart.templates.group_dotted_lines.link = '<path stroke-linejoin="round" stroke="#aeaeae" stroke-width="1px" fill="none" d="{rounded}" />'),
  (OrgChart.templates.group_dotted_lines.node = '<rect rx="5" ry="5" x="0" y="0" height="{h}" width="{w}" fill="#e5e5e5" stroke-width="0"></rect>'),
  (OrgChart.templates.group_dotted_lines.nodeGroupDottedCloseButton = '<g transform="matrix(1,0,0,1,{ew},0)"><circle cx="0.5" cy="21.5" r="12" fill="#F57C00"></circle>' + OrgChart.icon.close(25, 25, "#fff", -13, 8) + "</g>"),
  (OrgChart.templates.group_dotted_lines.field_0 = '<text data-width="230" style="font-size: 18px;" fill="#F57C00" x="20" y="30" text-anchor="start">Dotted Lines</text>'),
  ...
  (OrgChart.templates.group_dotted_lines.min = Object.assign({}, OrgChart.templates.olivia)),
  ...
  (OrgChart.ui = {
    ...
    node: function (t, e, r, i, a, n, o, l, s, h) {
      ...
      for (var p in o) {
        ...
        if (((g.value = u), (g.element = d[p]), (g.name = f), (g.field = p), !1 !== OrgChart.events.publish("field", [h, g]) && null != g.value && null != g.value && null != g.element && (!m || (m && !OrgChart.isNEU(g.value))))) {
          if (!m && "string" == typeof g.value) {
            var C = g.element;
            C && (C = C.replaceAll("{ew}", t.w - (t.padding ? t.padding[1] : 0)).replaceAll("{cw}", t.w / 2)), (g.value = OrgChart.wrapText(g.value, C));
          }
          var b = g.element.replace("{val}", g.value);
          c += b = b
      ...
      var O = OrgChart._getPosition(r, t, a, n),
        v = "node";
      Array.isArray(t.tags) && t.tags.length && (v += " " + t.tags.join(" ")), t.layout && (v += " tree-layout");
      var y = "";
      t.lcn && (y = 'lcn="' + t.lcn + '"');
      var x = OrgChart.nodeOpenTag.replace("{lcn}", y).replace("{id}", t.id).replace("{class}", v).replace("{sl}", t.sl).replace("{level}", t.level).replace("{x}", O.x).replace("{y}", O.y),
        _ = OrgChart._getOpacity(r, t);
      return (c = (x = x.replace("{opacity}", _)) + (c += OrgChart.ui.nodeBtns(i, t, l, d, h)) + OrgChart.grCloseTag);
    },
        ...
        if (e.childrenIds.length > 0) {
          ...
          if (
            ...
            t.getCollapsedIds(e).length
              ? ((n += OrgChart.expcollOpenTag.replace("{id}", e.id).replace("{x}", l).replace("{y}", s)), (n += h.plus), (n += OrgChart.grCloseTag))
              : ((n += OrgChart.expcollOpenTag.replace("{id}", e.id).replace("{x}", l).replace("{y}", s)), (n += h.minus), (n += OrgChart.grCloseTag)),
    ...
    link: function (t, e, r, i, a, n, o) {
      ...
      var p = 0,
        ...
        m = void 0;
      if (t.hasPartners) {
        m = { ids: [], indexes: {}, ppnodes: {}, lastLeft: null, firstRight: null, maxSidePartnersWithChildren: 0, rightIds: [], leftIds: [], partnerChildrenSplitSeparation: e.config.partnerChildrenSplitSeparation };
        for (var C = 0; C < t.children.length; C++) {
          (O = t.children[C]).parentPartner
            ? ((m.ppnodes[O.id] = O.parentPartner),
              m.ids.push(O.id),
              1 == O.parentPartner.isPartner
                ? (-1 == m.rightIds.indexOf(O.parentPartner.id) && m.rightIds.push(O.parentPartner.id), (m.indexes[O.id] = m.rightIds.indexOf(O.parentPartner.id)), m.firstRight || (m.firstRight = O))
                : 2 == O.parentPartner.isPartner && (-1 == m.leftIds.indexOf(O.parentPartner.id) && m.leftIds.push(O.parentPartner.id), (m.indexes[O.id] = m.leftIds.indexOf(O.parentPartner.id)), (m.lastLeft = O)))
            : O.isPartner || ((m.lastLeft = O), m.firstRight || (m.firstRight = O));
        }
        (m.maxSidePartnersWithChildren = Math.max(m.leftIds.length, m.rightIds.length)),
          (p = 0 == m.maxSidePartnersWithChildren ? e.config.minPartnerSeparation / 2 : e.config.minPartnerSeparation / 2 + m.partnerChildrenSplitSeparation * m.maxSidePartnersWithChildren + m.partnerChildrenSplitSeparation / 2);
      }
      for (C = 0; C < t.children.length; C++) {
        var b,
          ...
          x = (h = OrgChart.t(O.templateName, O.min, r)).link;
        if (O.isChildOfPartner)
          switch (s.orientation) {
            case OrgChart.orientation.top:
            case OrgChart.orientation.top_left:
              var _ = 1 == O.layout ? void 0 : v.minY - (v.minY - f.maxY) / 2;
              y = OrgChart.ui._linkTopToBottom(O.parentPartner, O, h, g, _);
              break;
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
              _ = 1 == O.layout ? void 0 : v.maxY - (v.maxY - f.minY) / 2;
              y = OrgChart.ui._linkBottomToTop(O.parentPartner, O, h, g, _);
              break;
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
              _ = 1 == O.layout ? void 0 : v.maxX - (v.maxX - f.minX) / 2;
              y = OrgChart.ui._linkRightToLeft(O.parentPartner, O, h, g, _);
              break;
            case OrgChart.orientation.left:
            case OrgChart.orientation.left_top:
              _ = 1 == O.layout ? void 0 : v.minX - (v.minX - f.maxX) / 2;
              y = OrgChart.ui._linkLeftToRight(O.parentPartner, O, h, g, _);
          }
        else if (m && -1 != m.ids.indexOf(O.id))
          switch (s.orientation) {
            case OrgChart.orientation.top:
            case OrgChart.orientation.top_left:
              y = OrgChart.ui._linkPpTop(m, t, O, v, f, h);
              break;
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
              y = OrgChart.ui._linkPpBottom(m, t, O, v, f, h);
              break;
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
              y = OrgChart.ui._linkPpRight(m, t, O, v, f, h);
              break;
            case OrgChart.orientation.left:
            case OrgChart.orientation.left_top:
              y = OrgChart.ui._linkPpLeft(m, t, O, v, f, h);
          }
        else {
          var w = O.isAssistant && O.rightNeighbor && O.rightNeighbor.isAssistant && O.parent == O.rightNeighbor.parent,
            k = O.isAssistant && O.leftNeighbor && O.leftNeighbor.isAssistant && O.parent == O.leftNeighbor.parent;
          if ((w || O.layout > 1) && O.rightNeighbor && O.rightNeighbor.isSplit)
            switch (s.orientation) {
              case OrgChart.orientation.top:
              case OrgChart.orientation.top_left:
              case OrgChart.orientation.bottom:
              case OrgChart.orientation.bottom_left:
                y = OrgChart.ui._linkRightToLeft(O.rightNeighbor, O, h, g);
                break;
              case OrgChart.orientation.right:
              case OrgChart.orientation.right_top:
              case OrgChart.orientation.left:
              case OrgChart.orientation.left_top:
                y = OrgChart.ui._linkBottomToTop(O.rightNeighbor, O, h, g);
            }
          else if ((k || O.layout > 1) && O.leftNeighbor && O.leftNeighbor.isSplit)
            switch (s.orientation) {
              case OrgChart.orientation.top:
              case OrgChart.orientation.top_left:
              case OrgChart.orientation.bottom:
              case OrgChart.orientation.bottom_left:
                y = OrgChart.ui._linkLeftToRight(O.leftNeighbor, O, h, g);
                break;
              case OrgChart.orientation.right:
              case OrgChart.orientation.right_top:
              case OrgChart.orientation.left:
              case OrgChart.orientation.left_top:
                y = OrgChart.ui._linkTopToBottom(O.leftNeighbor, O, h, g);
            }
          else
            switch (s.orientation) {
              case OrgChart.orientation.top:
              case OrgChart.orientation.top_left:
                if (1 == O.isPartner) y = OrgChart.ui._linkLeftToRight(t, O, h, p);
                else if (2 == O.isPartner) y = OrgChart.ui._linkRightToLeft(t, O, h, p);
                else {
                  _ = 1 == O.layout ? void 0 : v.minY - (v.minY - f.maxY) / 2;
                  y = OrgChart.ui._linkTopToBottom(t, O, h, g, _);
                }
                break;
              case OrgChart.orientation.bottom:
              case OrgChart.orientation.bottom_left:
                if (1 == O.isPartner) y = OrgChart.ui._linkLeftToRight(t, O, h, p);
                  ...
                  _ = 1 == O.layout ? void 0 : v.maxY - (v.maxY - f.minY) / 2;
                  y = OrgChart.ui._linkBottomToTop(t, O, h, g, _);
                }
                break;
              case OrgChart.orientation.right:
              case OrgChart.orientation.right_top:
                if (1 == O.isPartner) y = OrgChart.ui._linkTopToBottom(t, O, h, p);
                else if (2 == O.isPartner) y = OrgChart.ui._linkBottomToTop(t, O, h, p);
                else {
                  _ = 1 == O.layout ? void 0 : v.maxX - (v.maxX - f.minX) / 2;
                  y = OrgChart.ui._linkRightToLeft(t, O, h, g, _);
                }
                break;
              case OrgChart.orientation.left:
              case OrgChart.orientation.left_top:
                if (1 == O.isPartner) y = OrgChart.ui._linkTopToBottom(t, O, h, p);
                  ...
                  _ = 1 == O.layout ? void 0 : v.minX - (v.minX - f.maxX) / 2;
                  y = OrgChart.ui._linkLeftToRight(t, O, h, g, _);
                }
            }
        }
        var S = OrgChart.ui._draggableLinkPath(e, t, O, y, g, s.orientation);
        if (S) (b = S), (x = x.replace("{rounded}", S).replace("{edge}", S).replace("{curve}", b));
        else if (-1 != x.indexOf("{rounded}"))
          if ((y.xa == y.xb && y.xa == y.xc && y.xa == y.xd) || (y.ya == y.yb && y.ya == y.yc && y.ya == y.yd)) (b = "M" + y.xa + "," + y.ya + " L" + y.xd + "," + y.yd), (x = x.replace("{rounded}", b));
          else if (Math.abs(y.xa - y.xd) <= OrgChart.LINK_ROUNDED_CORNERS && Math.abs(y.xa - y.xc) <= OrgChart.LINK_ROUNDED_CORNERS && Math.abs(y.xa - y.xb) <= OrgChart.LINK_ROUNDED_CORNERS)
            (b = "M" + y.xa + "," + y.ya + " L" + y.xa + "," + y.yd), (x = x.replace("{rounded}", b));
          else if (Math.abs(y.ya - y.yd) <= OrgChart.LINK_ROUNDED_CORNERS && Math.abs(y.ya - y.yc) <= OrgChart.LINK_ROUNDED_CORNERS && Math.abs(y.ya - y.yb) <= OrgChart.LINK_ROUNDED_CORNERS)
            (b = "M" + y.xa + "," + y.ya + " L" + y.xd + "," + y.ya), (x = x.replace("{rounded}", b));
          else {
            var I = OrgChart.ui._roundedEdge(y.xa, y.ya, y.xb, y.yb, y.xc, y.yc),
              L = OrgChart.ui._roundedEdge(y.xb, y.yb, y.xc, y.yc, y.xd, y.yd);
            (b = "M" + I.x1 + "," + I.y1 + " " + I.x2 + "," + I.y2 + " Q" + I.qx1 + "," + I.qy1 + " " + I.qx2 + "," + I.qy2 + " L" + L.x2 + "," + L.y2 + " Q" + L.qx1 + "," + L.qy1 + " " + L.qx2 + "," + L.qy2 + " L" + L.x3 + "," + L.y3),
              (x = x.replace("{rounded}", b));
          }
        else
          -1 != x.indexOf("{edge}")
            ? ((b = "M" + y.xa + "," + y.ya + " " + y.xb + "," + y.yb + " " + y.xc + "," + y.yc + " L" + y.xd + "," + y.yd), (x = x.replace("{edge}", b)))
            : -1 != x.indexOf("{curve}")
            ? ((b = "M" + y.xa + "," + y.ya + " C" + y.xb + "," + y.yb + " " + y.xc + "," + y.yc + " " + y.xd + "," + y.yd), (x = x.replace("{curve}", b)))
            : ((b = x.replaceAll("{xa}", y.xa).replaceAll("{ya}", y.ya).replaceAll("{xb}", y.xb).replaceAll("{yb}", y.yb).replaceAll("{xc}", y.xc).replaceAll("{yc}", y.yc).replaceAll("{xd}", y.xd).replaceAll("{yd}", y.yd)), (x = b));
        d.push(
          OrgChart.linkOpenTag
            .replace("{id}", t.id)
            .replace("{class}", "link " + O.tags.join(" "))
            .replace("{child-id}", O.id)
        );
        var A = { node: t, cnode: O, p: y, html: x, action: n };
        OrgChart.events.publish("render-link", [e, A]), d.push(A.html), o && c.push({ id: t.id, childId: O.id, html: A.html });
        var N = "";
        for (var E in e.config.linkBinding) {
          ...
          if (T) {
            var B = T[M];
            (A.value = B), (A.element = h[E]), (A.name = M), !1 !== OrgChart.events.publish("label", [e, A]) && (OrgChart.isNEU(A.value) || OrgChart.isNEU(A.element) || (N += A.element.replace("{val}", A.value)));
          }
        }
        "" != N && ((N = OrgChart.linkFieldsOpenTag.replace("{x}", y.x).replace("{y}", y.y).replace("{rotate}", 0) + N + OrgChart.grCloseTag), d.push(N)), d.push(OrgChart.grCloseTag);
      }
      return o ? c : d.join("");
    },
    ...
    _roundedEdge: function (t, e, r, i, a, n) {
      ...
      return (
        (t == r && t == a) || (e == i && e == n)
          ? ((o = s = r), (l = d = i))
          : (t != a && r == a && ((o = s = r), (l = i), e < n ? (d = i + h) : e > n && (d = i - h)),
            t < a && r == a ? (r -= h) : t > a && r == a && (r += h),
            e != n && i == n && ((o = r), (l = d = i), t < a ? (s = r + h) : t > a && (s = r - h)),
            e < n && i == n ? (i -= h) : e > n && i == n && (i += h)),
        { x1: t, y1: e, x2: r, y2: i, x3: a, y3: n, qx1: o, qy1: l, qx2: s, qy2: d }
      );
    },
    ...
    _linkBottomToTop: function (t, e, r, i, a) {
      ...
      return (
        ...
        (h = e.y + e.h + r.linkAdjuster.fromY),
        {
          ...
          xb: n,
          yb: (d =
            t.rightNeighbor && t.rightNeighbor.isAssistant && "split" == e.templateName ? t.rightNeighbor.y - i : "split" == t.templateName && (e.isAssistant || e.layout > 1) ? h : "split" == e.templateName ? o - i : null != a ? a : h + i),
          xc: l,
          yc: d,
          xd: s,
          yd: h,
    ...
    _linkRightToLeft: function (t, e, r, i, a) {
      ...
      return (
        ...
        90,
        {
          ...
          ya: o,
          xb: (c =
            t.rightNeighbor && t.rightNeighbor.isAssistant && "split" == e.templateName ? t.rightNeighbor.x - i : "split" == t.templateName && (e.isAssistant || e.layout > 1) ? h : "split" == e.templateName ? n - i : null != a ? a : h + i),
          yb: l,
          xc: c,
          yc: s,
          xd: h,
    ...
    __linkPpBottomTop: function (t, e, r, i, a, n) {
      ...
      return (
        1 == n.isPartner
          ? ((o = n.x - e.partnerSeparation / 2 + t.indexes[r.id] * t.partnerChildrenSplitSeparation - ((t.rightIds.length - 1) * t.partnerChildrenSplitSeparation) / 2),
            t.lastLeft && o < t.lastLeft.x + t.lastLeft.w / 2
              ...
              : (i += (t.indexes[r.id] + 1) * a))
          : 2 == n.isPartner &&
            ((o = n.x + n.w + e.partnerSeparation / 2 + t.indexes[r.id] * t.partnerChildrenSplitSeparation - ((t.leftIds.length - 1) * t.partnerChildrenSplitSeparation) / 2),
    ...
    __linkPpLeftRight: function (t, e, r, i, a, n) {
      ...
      return (
        1 == n.isPartner
          ? ((o = n.y - e.partnerSeparation / 2 + t.indexes[r.id] * t.partnerChildrenSplitSeparation - ((t.rightIds.length - 1) * t.partnerChildrenSplitSeparation) / 2),
            t.lastLeft && o < t.lastLeft.y + t.lastLeft.h / 2
              ...
              : (i += (t.indexes[r.id] + 1) * a))
          : 2 == n.isPartner &&
            ((o = n.y + n.h + e.partnerSeparation / 2 + t.indexes[r.id] * t.partnerChildrenSplitSeparation - ((t.leftIds.length - 1) * t.partnerChildrenSplitSeparation) / 2),
    ...
    _draggableLinkPath: function (t, e, r, i, a, n) {
      ...
      if (OrgChart._isMoved(r) && !OrgChart._isMoved(e)) {
        ...
        switch (n) {
          ...
          case OrgChart.orientation.top_left:
            ...
            (s = i.xa < i.xd ? r.x - a / 2 : r.x + r.w + a / 2), (h = r.y - a / 2);
            break;
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
            if (i.yb - a / 2 > i.yd) return null;
            (s = i.xa < i.xd ? r.x - a / 2 : r.x + r.w + a / 2), (h = r.y + r.h + a / 2);
            break;
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
            if (i.xb - a / 2 > i.xd) return null;
            (h = i.ya < i.yd ? r.y - a / 2 : r.y + r.h + a / 2), (s = r.x + r.w + a / 2);
            break;
          case OrgChart.orientation.left:
          case OrgChart.orientation.left_top:
            if (i.xb + a / 2 < i.xd) return null;
            (h = i.ya < i.yd ? r.y - a / 2 : r.y + r.h + a / 2), (s = r.x - a / 2);
        }
        switch (n) {
          case OrgChart.orientation.top:
          case OrgChart.orientation.top_left:
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
            o.push(["M", i.xa, i.ya]), o.push(["L", i.xb, i.yb]), o.push(["L", s, i.yb]), o.push(["L", s, h]), o.push(["L", i.xd, h]), o.push(["L", i.xd, i.yd]);
            break;
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
          case OrgChart.orientation.left:
          case OrgChart.orientation.left_top:
            (o = []).push(["M", i.xa, i.ya]), o.push(["L", i.xb, i.yb]), o.push(["L", i.xb, h]), o.push(["L", s, h]), o.push(["L", s, i.yd]), o.push(["L", i.xd, i.yd]);
        }
      ...
      if (!OrgChart._isMoved(r) && OrgChart._isMoved(e)) {
        ...
        switch (n) {
          case OrgChart.orientation.top:
          case OrgChart.orientation.top_left:
            if (i.ya + a / 2 > i.yb) (l = !0), (s = i.xa < i.xd ? e.x + e.w + a / 2 : e.x - a / 2), (h = e.y + e.h + a);
            else {
              if (i.yb + a / 2 < i.yd) return null;
              (s = i.xa < i.xd ? r.x - a / 2 : r.x + r.w + a / 2), (h = r.y - a / 2);
            }
          ...
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
            if (i.ya - a / 2 < i.yb) (l = !0), (s = i.xa < i.xd ? e.x + e.w + a / 2 : e.x - a / 2), (h = e.y - a);
            else {
              if (i.yb - a / 2 > i.yd) return null;
              (s = i.xa < i.xd ? r.x - a / 2 : r.x + r.w + a / 2), (h = r.y + r.h + a / 2);
            }
          ...
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
            if (i.xa - a / 2 < i.xb) (l = !0), (h = i.ya < i.yd ? e.y + e.h + a / 2 : e.y - a / 2), (s = e.x - a);
            else {
              if (i.xb - a / 2 > i.xd) return null;
              (h = i.ya < i.yd ? r.y - a / 2 : r.y + r.h + a / 2), (s = r.x + r.w + a / 2);
            }
          ...
          case OrgChart.orientation.left:
          case OrgChart.orientation.left_top:
            if (i.xa + a / 2 > i.xb) (l = !0), (h = i.ya < i.yd ? e.y + e.h + a / 2 : e.y - a / 2), (s = e.x + e.w + a);
            else {
              if (i.xb + a / 2 < i.xd) return null;
              (h = i.ya < i.yd ? r.y - a / 2 : r.y + r.h + a / 2), (s = r.x - a / 2);
            }
        ...
        if (l)
          switch (n) {
            ...
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
              o.push(["M", i.xa, i.ya]), o.push(["L", i.xa, h]), o.push(["L", s, h]), o.push(["L", s, i.yc]), o.push(["L", i.xc, i.yc]), o.push(["L", i.xd, i.yd]);
              break;
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
            case OrgChart.orientation.left:
            case OrgChart.orientation.left_top:
              o.push(["M", i.xa, i.ya]), o.push(["L", s, i.ya]), o.push(["L", s, h]), o.push(["L", i.xc, h]), o.push(["L", i.xc, i.yc]), o.push(["L", i.xd, i.yd]);
          }
        else
          switch (n) {
            case OrgChart.orientation.top:
          ...
          case OrgChart.orientation.top_left:
            if (i.ya + a > i.yd) {
              var s = i.xa < i.xd ? e.x + e.w + a / 2 : e.x - a / 2,
                h = e.y + e.h + a,
                d = r.y - a;
              o.push(["M", i.xa, i.ya]), o.push(["L", i.xa, h]), o.push(["L", s, h]), o.push(["L", s, d]), o.push(["L", i.xc, d]), o.push(["L", i.xd, i.yd]);
            } else o.push(["M", i.xa, i.ya]), o.push(["L", i.xa, e.y + e.h + a]), o.push(["L", i.xc, e.y + e.h + a]), o.push(["L", i.xd, i.yd]);
            break;
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
            if (i.ya - a < i.yd) {
              (s = i.xa < i.xd ? e.x + e.w + a / 2 : e.x - a / 2), (h = e.y - a), (d = r.y + r.h + a);
              o.push(["M", i.xa, i.ya]), o.push(["L", i.xa, h]), o.push(["L", s, h]), o.push(["L", s, d]), o.push(["L", i.xc, d]), o.push(["L", i.xd, i.yd]);
            } else o.push(["M", i.xa, i.ya]), o.push(["L", i.xa, e.y - a]), o.push(["L", i.xc, e.y - a]), o.push(["L", i.xd, i.yd]);
            break;
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
            if (i.xa - a < i.xd) {
              (h = i.ya < i.yd ? e.y + e.h + a / 2 : e.y - a / 2), (s = e.x - a);
              var c = r.x + r.w + a;
              o.push(["M", i.xa, i.ya]), o.push(["L", s, i.ya]), o.push(["L", s, h]), o.push(["L", c, h]), o.push(["L", c, i.yc]), o.push(["L", i.xd, i.yd]);
            } else o.push(["M", i.xa, i.ya]), o.push(["L", e.x - a, i.ya]), o.push(["L", e.x - a, i.yc]), o.push(["L", i.xd, i.yd]);
            break;
          case OrgChart.orientation.left:
          case OrgChart.orientation.left_top:
            if (i.xa + a > i.xd) {
              (h = i.ya < i.yd ? e.y + e.h + a / 2 : e.y - a / 2), (s = e.x + e.w + a), (c = r.x - a);
              o.push(["M", i.xa, i.ya]), o.push(["L", s, i.ya]), o.push(["L", s, h]), o.push(["L", c, h]), o.push(["L", c, i.yc]), o.push(["L", i.xd, i.yd]);
            } else o.push(["M", i.xa, i.ya]), o.push(["L", e.x + e.w + a, i.ya]), o.push(["L", e.x + e.w + a, i.yc]), o.push(["L", i.xd, i.yd]);
        }
        return OrgChart.roundPathCorners(o, OrgChart.LINK_ROUNDED_CORNERS, !1);
      }
      return null;
  ...
  (OrgChart._moveToBoundaryArea = function (t, e, r, i) {
    ...
    e[0] < r.left && e[0] < r.right && (a[0] = r.left > r.right ? r.right : r.left),
      ...
      e[0] !== a[0] || e[1] !== a[1]
        ? OrgChart.animate(t, { viewBox: e }, { viewBox: a }, 300, OrgChart.anim.outPow, function () {
            i && i();
          })
        : i && i();
  }),
  ...
  (OrgChart._browser = function () {
    var t = (!!window.opr && !!window.opr.addons) || !!window.opera || navigator.userAgent.indexOf(" OPR/") >= 0,
      ...
      r = /constructor/i.test(window.HTMLElement) || "[object SafariRemoteNotification]" === (!window.safari || (void 0 !== window.safari && safari.pushNotification)).toString(),
  ...
  (OrgChart.wrapText = function (t, e) {
    ...
    if (OrgChart.ESCAPE_HTML && "string" == typeof str && OrgChart._isHTML(t)) return OrgChart._escapeHtml(t);
    if (!OrgChart.ESCAPE_HTML && OrgChart._isHTML(t)) return t;
    var i = OrgChart._getTestDiv();
    (e = e.replaceAll("{cw}", 0)), (i.innerHTML = "<svg>" + e + "</svg>");
    var a,
      n,
      o = new DOMParser().parseFromString(e, "text/xml").getElementsByTagName("text")[0],
    ...
    c || (c = "ellipsis");
    var u = c.split("-");
    if ((u.length > 1 && ((a = parseInt(c.split("-")[1])), u.length > 2 && "ellipsis" == u[2] && (n = !0)), !d)) return OrgChart._escapeHtml(t);
    if (((d = parseFloat(d)), l || (l = 0), s || (s = 0), l || (h = "start"), "ellipsis" == c)) {
      ...
      return m > 2 ? `<title>${OrgChart._escapeHtml(t)}</title>${p.textContent}` : OrgChart._escapeHtml(t);
    }
    if (-1 != c.indexOf("multiline")) {
      ...
      m = 1;
      for (var y = 1, x = 1; x < C.length; x++) {
        var _ = O.firstChild.data.length;
        if (((O.firstChild.data += " " + C[x]), O.getComputedTextLength() > d)) {
          if (((O.firstChild.data = O.firstChild.data.slice(0, _)), y++, a && y > a)) {
      ...
      if (null != p.innerHTML) (k = p.innerHTML), (p.innerHTML = "");
        ...
        var S = "";
        for (x = p.childNodes.length - 1; x >= 0; x--) (S = XMLSerializer().serializeToString(p.childNodes[x]) + S), p.removeChild(p.childNodes[x]);
        k = S;
      }
      return k;
    }
  ...
  (OrgChart._json2csv = function (t) {
    for (
        ...
        r = function (t) {
          for (var r = "", i = 0; i < e.length; i++) {
            ...
            var n = (a = null === a ? "" : a.toString()).replace(/"/g, '""'),
              o = new RegExp('("|;|\n)', "g");
            n.search(o) >= 0 && (n = '"' + n + '"'), i > 0 && (r += OrgChart.CSV_DELIMITER), (r += n);
          }
          return r + "\n";
        },
        i = "",
      ...
      for (var n in t[a]) OrgChart._arrayContains(e, n) || (e.push(n), (i += n + OrgChart.CSV_DELIMITER));
  ...
  (OrgChart.collapsedChildrenTotalCount = function (t, e, r) {
    for (var i = 0, a = 0; a < e.childrenIds.length; a++) {
      ...
      n && ((r || !0 === n.collapsed) && i++, (i += OrgChart.collapsedChildrenTotalCount(t, n, !0)));
    }
    return i;
  }),
  ...
  (OrgChart._escapeHtml = function (t) {
    return OrgChart.ESCAPE_HTML && "string" == typeof t ? t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#039;") : t;
  }),
  ...
  (OrgChart.roundPathCorners = function (t, e, r) {
    ...
    if (t.length > 1) {
      var s = o(t[0]),
        h = null;
      "Z" == t[t.length - 1][0] && t[0].length > 2 && ((h = ["L", s.x, s.y]), (t[t.length - 1] = h)), l.push(t[0]);
      for (var d = 1; d < t.length; d++) {
        var c = l[l.length - 1],
          g = t[d],
          p = g == h ? t[1] : t[d + 1];
        if (p && c && c.length > 2 && "L" == g[0] && p.length > 2 && "L" == p[0]) {
          var u,
            f,
            m = o(c),
            C = o(g),
            b = o(p);
          r ? ((u = a(C, c.origPoint || m, e)), (f = a(C, p.origPoint || b, e))) : ((u = i(C, m, e)), (f = i(C, b, e))), n(g, u), (g.origPoint = C), l.push(g);
          var O = a(u, C, 0.5),
            v = a(C, f, 0.5),
            y = ["C", O.x, O.y, v.x, v.y, f.x, f.y];
  ...
  (OrgChart.xScrollUI = function (t, e, r, i, a) {
    (this.element = t), (this.requestParams = r), (this.config = e), (this.onSetViewBoxCallback = i), (this.onDrawCallback = a), (this.pos = 0), (this.bar = null);
  }),
  (OrgChart.xScrollUI.prototype.addListener = function (t) {
    ...
    if ((this.config.mouseScrool == OrgChart.action.xScroll || this.config.mouseScrool == OrgChart.action.scroll) && this.bar) {
      ...
      !(function (t, i, a) {
        ...
        function o() {
          n = !0;
          var t = (e.pos - e.bar.scrollLeft) / a;
          if (t > 0) t++;
          else {
            if (0 == t) return void (n = !1);
            t--;
          }
          Math.ceil(e.bar.scrollLeft) == Math.ceil(e.pos) ? (n = !1) : ((e.bar.scrollLeft += t), l(o));
        }
        t.addEventListener(
          "wheel",
          function (t) {
            if (t.ctrlKey) return;
            var a = 0;
            if (e.config.mouseScrool == OrgChart.action.xScroll) (a = t.deltaX || t.wheelDeltaX) || (a = t.deltaY || t.wheelDeltaY);
            else if (e.config.mouseScrool == OrgChart.action.scroll && !(a = r || !t.shiftKey ? t.deltaX || t.wheelDeltaX : t.deltaY || t.wheelDeltaY)) return;
            (a = -a), (a = Math.max(-1, Math.min(1, a))), (e.pos += -a * i);
            var l = parseFloat(e.innerBar.clientWidth) - parseFloat(e.bar.clientWidth);
            e.pos < 0 && (e.pos = 0);
            e.pos > l && (e.pos = l);
            n || o();
          },
  ...
  (OrgChart.xScrollUI.prototype.setPosition = function () {
    if (this.bar) {
      var t = this.requestParams(),
        e = (Math.abs(t.boundary.maxX - t.boundary.minX) + 2 * this.config.padding) * t.scale;
      ...
      var a = (parseFloat(this.innerBar.clientWidth) - parseFloat(this.bar.clientWidth)) / 100,
        n = i * a;
      (this.bar.ignore = !0), (this.bar.scrollLeft = n), (this.pos = this.bar.scrollLeft), (this.bar.style.visibility = a <= 0 ? "hidden" : ""), this.config.showXScroll !== OrgChart.scroll.visible && (this.bar.style.visibility = "hidden");
    }
  }),
  ...
  (OrgChart.yScrollUI.prototype.addListener = function (t) {
    var e = this;
    if ((this.config.mouseScrool == OrgChart.action.yScroll || this.config.mouseScrool == OrgChart.action.scroll) && this.bar) {
      var r = -1 !== navigator.userAgent.indexOf("Mac OS"),
        i = OrgChart._getScrollSensitivity();
      !(function (t, i, a) {
        var n = !1;
        function o() {
          n = !0;
          var t = (e.pos - e.bar.scrollTop) / a;
          if (t > 0) t++;
          else {
            if (0 == t) return void (n = !1);
            t--;
          }
          Math.ceil(e.bar.scrollTop) == Math.ceil(e.pos) ? (n = !1) : ((e.bar.scrollTop += t), l(o));
        }
        t.addEventListener(
          "wheel",
          function (t) {
            if (t.ctrlKey) return;
            var a = 0;
            if (e.config.mouseScrool == OrgChart.action.yScroll) (a = t.deltaY || t.wheelDeltaY) || (a = t.deltaX || t.wheelDeltaX);
            else if (e.config.mouseScrool == OrgChart.action.scroll && !(a = r || !t.shiftKey ? t.deltaY || t.wheelDeltaY : t.deltaX || t.wheelDeltaX)) return;
            (a = -a), (a = Math.max(-1, Math.min(1, a))), (e.pos += -a * i);
            var l = parseFloat(e.innerBar.clientHeight) - parseFloat(e.bar.clientHeight);
            e.pos < 0 && (e.pos = 0);
            e.pos > l && (e.pos = l);
            n || o();
          },
  ...
  (OrgChart.yScrollUI.prototype.setPosition = function () {
    if (this.bar) {
      var t = this.requestParams(),
        e = (Math.abs(t.boundary.maxY - t.boundary.minY) + 2 * this.config.padding) * t.scale;
      switch (this.config.orientation) {
        case OrgChart.orientation.bottom:
        case OrgChart.orientation.bottom_left:
      ...
      var a = (parseFloat(this.innerBar.clientHeight) - parseFloat(this.bar.clientHeight)) / 100,
        n = i * a;
      (this.bar.ignore = !0), (this.bar.scrollTop = n), (this.pos = this.bar.scrollTop), (this.bar.style.visibility = a <= 0 ? "hidden" : ""), this.config.showYScroll !== OrgChart.scroll.visible && (this.bar.style.visibility = "hidden");
    }
  }),
  (OrgChart.prototype.zoom = function (t, e, r, i) {
    var a = this.getViewBox().slice(0),
      ...
      o = a[2],
      l = a[3];
    !0 === t ? ((a[2] = a[2] / OrgChart.SCALE_FACTOR), (a[3] = a[3] / OrgChart.SCALE_FACTOR)) : !1 === t ? ((a[2] = a[2] * OrgChart.SCALE_FACTOR), (a[3] = a[3] * OrgChart.SCALE_FACTOR)) : ((a[2] = a[2] / t), (a[3] = a[3] / t)),
      e || (e = [50, 50]),
    ...
    if (((a[2] = this.width() / s), (a[3] = this.height() / s), (!0 === t && s < this.config.scaleMax) || (!1 === t && s > this.config.scaleMin) || (0 != t && 1 != t && s < this.config.scaleMax && s > this.config.scaleMin))) {
      ...
      r
        ? (clearTimeout(h._timeout),
          OrgChart.animate(this.getSvg(), { viewbox: this.getViewBox() }, { viewbox: a }, this.config.anim.duration, this.config.anim.func, function () {
            clearTimeout(h._timeout),
  ...
  (OrgChart.pdfPrevUI.show = function (t, e) {
    ...
    (i.id = "boc-ppdf-wrapper"),
      Object.assign(i.style, { "overflow-y": "scroll", "z-index": 11, position: "absolute", top: 0, left: "285px", "background-color": "#eee", width: t.width() - 270 + "px", height: "100%" }),
    ...
    (l.value = e.format),
      ...
      (c.value = e.header),
      (g.value = e.footer),
      OrgChart.animate(t.element.querySelector("#boc-ppdf-btns"), { margin: [0, 0, 0, -250] }, { margin: [0, 0, 0, 0] }, 300, OrgChart.anim.outSin, function () {
      ...
      c.addEventListener("keyup", function () {
        clearTimeout(n),
          (n = setTimeout(function () {
            OrgChart.animate(t.element.querySelector("#boc-ppdf-content"), { opacity: 1 }, { opacity: 0 }, 300, OrgChart.anim.inSin, function () {
              (t.element.querySelector("#boc-ppdf-content").innerHTML = ""), (e.header = c.value), t.exportPDF(e, OrgChart.pdfPrevUI._handler);
            });
          }, 1e3));
      }),
  ...
  (OrgChart.pdfPrevUI._handler = function (t, e, r) {
    ...
    for (var s = l.querySelector("svg"), h = t.element.querySelector("#boc-ppdf-content"), d = 0; d < a.length; d++) {
      var c = document.createElement("iframe");
      Object.assign(c.style, { display: "block", margin: "10px auto", border: "1px solid #eeeeee", "box-shadow": "0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)" }),
        h.appendChild(c),
        s && s.style.backgroundColor ? (c.style.backgroundColor = s.style.backgroundColor) : (c.style.backgroundColor = "#fff");
      ...
      a[d].footer && (u = a[d].footer),
        u && (u = u.replace("{current-page}", d + 1).replace("{total-pages}", a.length)),
        a[d].html
          ? g.write(OrgChart._exportHtml(a[d].html, e.styles, i, a[d].innerSize.w, a[d].innerSize.h, p, u, t.config.mode))
          : (s.setAttribute("viewBox", a[d].vb), g.write(OrgChart._exportHtml(l.innerHTML, e.styles, i, a[d].innerSize.w, a[d].innerSize.h, p, u, t.config.mode)));
  ...
  (OrgChart._exportHtml = function (t, e, r, i, a, n, o, l) {
    ...
    var d = '<!DOCTYPE html><html style="margin:0;padding:0;"><head></head>' + e + '<body class="boc-' + l + '" style="margin:0; padding:0;"><div style="margin: ' + s + ";overflow:hidden;width:" + i + "px;height:" + a + 'px">';
    return (
      n && (d += '<div id="boc-header" style="width:' + i + "px;color:#757575;position:absolute;left:" + r.margin[3] + 'px;top:0;">' + n + "</div>"),
      (d += t),
      o && (d += '<div id="boc-footer" style="width:' + i + "px;color:#757575;position:absolute;left:" + r.margin[3] + 'px;bottom:0;">' + o + "</div>"),
      (d += "</div>"),
      (d += "</body></html>")
    );
  }),
  ...
  OrgChart.events.on("drag", function (t, e, r, i) {
    if (t instanceof OrgChart && t.config.draggable)
      for (var a = 0; a < i.length; a++) {
        for (var n = i[a], o = t.element.querySelectorAll(`[data-c-l-from="${n}"]`), l = t.element.querySelectorAll(`[data-c-l-to="${n}"]`), s = 0; s < o.length; s++) o[s].parentNode.removeChild(o[s]);
  ...
  (OrgChart.prototype._clink = function (t, e) {
    for (var r = "", i = 0; i < this.config.clinks.length; i++) {
      var a = this.config.clinks[i],
        n = t.getNode(a.from),
        o = t.getNode(a.to);
      if (n && -1 != e.res.visibleNodeIds.indexOf(n.id) && o && -1 != e.res.visibleNodeIds.indexOf(o.id)) {
        var l = n.x,
          s = n.y,
          h = o.x,
          d = o.y,
        ...
        switch (this.config.orientation) {
          case OrgChart.orientation.top:
          case OrgChart.orientation.top_left:
            p <= u ? ((C = 1), (c.x = p + n.w / 10), (g.x = u - o.w / 10)) : ((C = -1), (c.x = p - n.w / 10), (g.x = u + o.w / 10)),
              s == d ? ((C = 1), (c.y = s), (g.y = d)) : s > d ? ((c.y = s), (g.y = d + o.h)) : ((c.y = s + n.h), (g.y = d));
            break;
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
            p <= u ? ((C = -1), (c.x = p + n.w / 10), (g.x = u + o.w / 10)) : ((C = 1), (c.x = p - n.w / 10), (g.x = u + o.w / 10)),
              s == d ? ((C = -1), (c.y = s + n.h), (g.y = d + o.h)) : s > d ? ((c.y = s), (g.y = d + o.h)) : ((c.y = s + n.h), (g.y = d));
            break;
          case OrgChart.orientation.left:
          case OrgChart.orientation.left_top:
            f <= m ? ((C = -1), (c.y = f + n.h / 5), (g.y = m + o.h / 5)) : ((C = 1), (c.y = f - n.h / 5), (g.y = m + o.h / 5)),
              l == h ? ((C = -1), (c.x = l), (g.x = h)) : l > h ? ((c.x = l), (g.x = h + o.w)) : ((c.x = l + n.w), (g.x = h));
            break;
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
            f <= m ? ((C = 1), (c.y = f + n.h / 5), (g.y = m + o.h / 5)) : ((C = -1), (c.y = f - n.h / 5), (g.y = m + o.h / 5)),
              l == h ? ((C = 1), (c.x = l + n.w), (g.x = h + o.w)) : l > h ? ((c.x = l), (g.x = h + o.w)) : ((c.x = l + n.w), (g.x = h));
        }
        var b = _(c, g, C),
          O = a.template;
        O || (O = "orange");
        var v = OrgChart.clinkTemplates[O];
        if (a.label) {
          var y = OrgChart.clinkLabelPosition(a, c, g, b);
          r += v.label.replace("{x}", y.x).replace("{y}", y.y).replace("{val}", a.label);
        }
        var x = "M" + c.x + "," + c.y + "C" + c.x + "," + c.y + " " + b.x + "," + b.y + " " + g.x + "," + g.y;
        (r +=
          ("<g " + OrgChart.attr.c_link_from + '="{from}" ' + OrgChart.attr.c_link_to + '="{to}">').replace("{from}", n.id).replace("{to}", o.id) +
      ...
      function _(t, e, r) {
        ...
        return (o = (o / (Math.sqrt(i * i + n * n) * r)) * OrgChart.clinkCurve(a)), { x: t.x + i / 2 - n * o, y: t.y + n / 2 + i * o };
      }
    }
    e.content += r;
  }),
  ...
  (OrgChart.prototype.addClink = function (t, e, r, i) {
    ...
    return this.config.clinks.push({ from: t, to: e, label: r, template: i }), OrgChart.events.publish("updated", [this]), this;
  }),
  ...
  OrgChart.events.on("drag", function (t, e, r, i) {
    if (t instanceof OrgChart && t.config.draggable)
      for (var a = 0; a < i.length; a++) {
        for (var n = i[a], o = t.element.querySelectorAll(`[data-s-l-from="${n}"]`), l = t.element.querySelectorAll(`[data-s-l-to="${n}"]`), s = 0; s < o.length; s++) o[s].parentNode.removeChild(o[s]);
        for (s = 0; s < l.length; s++) l[s].parentNode.removeChild(l[s]);
      }
  }),
  (OrgChart.prototype._slinks = function (t, e) {
    ...
    function n(e, n, o) {
      ...
      var f = { p: e.x + e.w / 2 + p.expandCollapseSize, q: e.y, r: e.x + e.w / 2 + p.expandCollapseSize, s: a.minY + u };
      if (e.sl == n.sl)
        ...
        for (; null == h; ) {
          var b = !1,
            ...
            v = O.leftNeighbor,
            y = O.rightNeighbor;
          if ((O.id == n.id ? (h = O) : OrgChart._intersects(O, f, g) && ((f = OrgChart._addPoint(O, s, g, f, d)), (b = !0)), O.id != n.id)) {
            for (; v; ) {
              if (v.id == n.id) {
                h = v;
                break;
              }
              OrgChart._intersects(v, f, g) && ((f = OrgChart._addPoint(v, s, g, f, d)), (b = !0)), (v = v.leftNeighbor);
            }
            for (; y; ) {
              if (y.id == n.id) {
                h = y;
              ...
              OrgChart._intersects(y, f, g) && ((f = OrgChart._addPoint(y, s, g, f, d)), (b = !0)), (y = y.rightNeighbor);
            }
          }
          if (!b) {
            var x = s[s.length - 1][0],
              _ = 0;
            if (O.parent) {
              (u = g.levelSeparation), O.parent.layout && (u = g.mixedHierarchyNodesSeparation);
      ...
      switch ((p = OrgChart.slinkTemplates[k]).labelPosition) {
        case "start":
          ...
          break;
        case "middle":
          var A = Math.ceil(s.length / 2);
          (S = s[A]), (I = s[A - 1]), (L = { x: (S[0] + I[0]) / 2, y: (S[1] + I[1]) / 2 });
          break;
        case "end":
          L = { x: s[s.length - 2][0], y: s[s.length - 2][1] };
      }
      o && (s = s.reverse()), s[0].unshift("M");
      for (var N = 1; N < s.length; N++) s[N].unshift("L");
      if (((pathStr = OrgChart.roundPathCorners(s, OrgChart.LINK_ROUNDED_CORNERS, !1)), l.label)) {
        var E = p.label.replace("{x}", L.x).replace("{y}", L.y).replace("{val}", l.label),
          M = OrgChart._getLabelSize(E),
          T = -M.height / 2;
        switch (g.orientation) {
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
      ...
      o && ((B = n.id), (U = e.id)),
        (r +=
          ("<g " + OrgChart.attr.s_link_from + '="{from}" ' + OrgChart.attr.s_link_to + '="{to}">').replace("{from}", B).replace("{to}", U) +
          p.link.replaceAll("{d}", pathStr) +
          '<path stroke="transparent" stroke-width="15" fill="none" d="' +
          pathStr +
          '" />'),
        (r += OrgChart.grCloseTag);
    ...
    for (var o = 0; o < this.config.slinks.length; o++) {
      var l = this.config.slinks[o],
        s = t.getNode(l.from),
        h = t.getNode(l.to);
      s && h && -1 != e.res.visibleNodeIds.indexOf(h.id) && -1 != e.res.visibleNodeIds.indexOf(s.id) && (s.sl >= h.sl ? n(s, h, !1) : n(h, s, !0));
    }
    e.content += r;
  }),
  (OrgChart.prototype.addSlink = function (t, e, r, i) {
    ...
    return this.config.slinks.push({ from: t, to: e, label: r, template: i }), OrgChart.events.publish("updated", [this]), this;
  }),
  ...
  OrgChart.events.on("renderbuttons", function (t, e) {
    if (e.node && e.node.tags && e.node.tags.has("group-dotted-lines")) {
      var r = t.getScale(),
        ...
        a = "";
      e.node.min
        ? (i.nodeGroupDottedOpenButton || console.error(`[${e.node.templateName}].nodeGroupDottedOpenButton is not defined`),
        ...
        : (i.nodeGroupDottedCloseButton || console.error(`[${e.node.templateName}].nodeGroupDottedCloseButton is not defined`),
        ...
        (a = (a += "</g>")
          ...
          .replaceAll("{ew}", e.node.w - (e.node.padding ? e.node.padding[1] : 0))
          .replaceAll("{eh}", e.node.h - (e.node.padding ? e.node.padding[2] : 0)));
  ...
  OrgChart.events.on("redraw", function (t, e) {
    if (t.config.groupDottedLines.length) {
      for (var r = t.element.querySelectorAll("[data-ctrl-n-dotted-close]"), i = 0; i < r.length; i++)
  ...
  (OrgChart.prototype.clearRedo = function () {
    if (this.config.undoRedoStorageName) {
      for (var t = `${this.config.undoRedoStorageName}_redo_`, e = Object.keys(sessionStorage), r = 0; -1 != e.indexOf(t + r); ) sessionStorage.removeItem(t + r), r++;
      this.undoRedoUI.refresh();
    }
  }),
  (OrgChart.prototype.clearUndo = function () {
    if (this.config.undoRedoStorageName) {
      for (var t = `${this.config.undoRedoStorageName}_undo_`, e = Object.keys(sessionStorage), r = 0; -1 != e.indexOf(t + r); ) sessionStorage.removeItem(t + r), r++;
      this.undoRedoUI.refresh();
    }
  }),
  (OrgChart.prototype.undoStepsCount = function () {
    for (var t = `${this.config.undoRedoStorageName}_undo_`, e = Object.keys(sessionStorage), r = 0; -1 != e.indexOf(t + r); ) r++;
    return r;
  }),
  (OrgChart.prototype.redoStepsCount = function () {
    for (var t = `${this.config.undoRedoStorageName}_redo_`, e = Object.keys(sessionStorage), r = 0; -1 != e.indexOf(t + r); ) r++;
    return r;
  }),
  (OrgChart.prototype._putInUndoStack = function () {
    if (this.config.undoRedoStorageName) {
      var t = `${this.config.undoRedoStorageName}_undo_` + this.undoStepsCount();
      sessionStorage.setItem(t, JSON.stringify({ nodes: this.config.nodes, clinks: this.config.clinks, slinks: this.config.slinks, groupDottedLines: this.config.groupDottedLines, dottedLines: this.config.dottedLines }));
    }
  }),
  (OrgChart.prototype._putInRedoStack = function () {
    if (this.config.undoRedoStorageName) {
      var t = `${this.config.undoRedoStorageName}_redo_` + this.redoStepsCount();
      sessionStorage.setItem(t, JSON.stringify({ nodes: this.config.nodes, clinks: this.config.clinks, slinks: this.config.slinks, groupDottedLines: this.config.groupDottedLines, dottedLines: this.config.dottedLines }));
    }
  }),
  void 0 === OrgChart && (OrgChart = {}),
  ...
  (OrgChart.undoRedoUI.prototype.refresh = function () {
    ...
    if (this.instance.config.undoRedoStorageName) {
      var e = { undoStepsCount: this.instance.undoStepsCount(), redoStepsCount: this.instance.redoStepsCount() };
      if (!1 !== OrgChart.events.publish("change", [this, e])) {
        ...
        if (!r || !i) {
          ...
          a.classList.add("boc-undo-redo"),
            (a.innerHTML = `<span data-undo>${OrgChart.icon.undo(50, 50, "")}<span class="boc-undo-i"></span></span>\n                            <span data-redo>${OrgChart.icon.redo(50, 50, "")}<span class="boc-redo-i"></span></span>`),
        ...
        e.undoStepsCount > 0
          ? (r.classList.add("boc-ur-clickable"), (r.querySelector(".boc-undo-i").innerHTML = e.undoStepsCount), (r.querySelector(".boc-undo-i").style.display = "inline-block"))
          : (r.classList.remove("boc-ur-clickable"), (r.querySelector(".boc-undo-i").style.display = "none")),
          e.redoStepsCount > 0
            ? (i.classList.add("boc-ur-clickable"), (i.querySelector(".boc-redo-i").innerHTML = e.redoStepsCount), (i.querySelector(".boc-redo-i").style.display = "inline-block"))
            : (i.classList.remove("boc-ur-clickable"), (i.querySelector(".boc-redo-i").style.display = "none"));
      }
    }
  }),
  ...
  OrgChart.events.on("redraw", function (t, e) {
    if (t.config.miniMap) {
      if (t.manager.action != OrgChart.action.move) {
        (OrgChart.miniMap._settings._scale = Math.min(OrgChart.miniMap.width / (t.response.boundary.maxX - t.response.boundary.minX), OrgChart.miniMap.height / (t.response.boundary.maxY - t.response.boundary.minY))),
          (OrgChart.miniMap._settings._translateX = -t.response.boundary.minX * OrgChart.miniMap._settings._scale + (OrgChart.miniMap.width - (t.response.boundary.maxX - t.response.boundary.minX) * OrgChart.miniMap._settings._scale) / 2),
          (OrgChart.miniMap._settings._translateY = -t.response.boundary.minY * OrgChart.miniMap._settings._scale + (OrgChart.miniMap.height - (t.response.boundary.maxY - t.response.boundary.minY) * OrgChart.miniMap._settings._scale) / 2);
        var r = t.getViewBox();
        OrgChart.miniMap._init(t), OrgChart.miniMap._drawMainCanvas(t), OrgChart.miniMap._drawRectSelectorCanvas(t, r);
        var i,
          a,
          n,
          o,
        ...
        (l.onmousedown = function (t) {
          ...
          if (
            ...
            (e = a),
            (n = (i - OrgChart.miniMap._settings._translateX) / OrgChart.miniMap._settings._scale),
            (o = (e - OrgChart.miniMap._settings._translateY) / OrgChart.miniMap._settings._scale),
  ...
  (OrgChart.miniMap._drawMainCanvas = function (t) {
    ...
    !(function t(e, n) {
      if (Array.isArray(n)) for (var o = 0; o < n.length; o++) t(e, n[o]);
        ...
        (r.fillStyle = OrgChart.miniMap.colors[3]), r.beginPath(), (r.lineWidth = "0.5"), r.fillRect(n.x, n.y, n.w, n.h), r.strokeRect(n.x, n.y, n.w, n.h);
        for (o = 0; o < n.stChildrenIds.length; o++)
          i++,
            a.includes(n.id) ||
              (1 == i ? (r.fillStyle = OrgChart.miniMap.colors[0]) : 2 == i ? (r.fillStyle = OrgChart.miniMap.colors[1]) : 3 == i && (r.fillStyle = OrgChart.miniMap.colors[2]),
              r.beginPath(),
            ...
            i--;
        for (o = 0; o < n.childrenIds.length; o++) t(e, e.getNode(n.childrenIds[o]));
      }
    })(t, t.roots);
  }),
  (OrgChart.miniMap._drawRectSelectorCanvas = function (t, e) {
    ...
    var a = e[0],
      ...
      o = e[2],
      l = e[3];
    (i.lineWidth = 0.5 / OrgChart.miniMap._settings._scale), (i.strokeStyle = OrgChart.miniMap.focusStroke), (i.globalAlpha = 1), i.clearRect(a, n, o, l), i.strokeRect(a, n, o, l);
  }),
  (OrgChart.miniMap._initCtx = function (t, e, r) {
    ...
    (e.width = e.width),
      ...
      (i.globalAlpha = r),
      1 != r && ((i.fillStyle = OrgChart.miniMap.selectorBackgroundColor), i.fillRect(0, 0, OrgChart.miniMap.width, OrgChart.miniMap.height)),
      i.translate(OrgChart.miniMap._settings._translateX, OrgChart.miniMap._settings._translateY),
      i.scale(OrgChart.miniMap._settings._scale, OrgChart.miniMap._settings._scale);
  }),
  (OrgChart.miniMap._init = function (t) {
    if (!t.element.querySelector('[data-id="mini-map"]')) {
      ...
      (r.width = OrgChart.miniMap.width), (r.height = OrgChart.miniMap.height), r.setAttribute("data-id", "mini-map-focus"), (r.style.display = "inline-block"), (r.style.position = "absolute"), (r.style.top = 0), (r.style.left = 0);
      var i = document.createElement("div");
      i.setAttribute("data-id", "mini-map"), (i.style.position = "absolute");
      for (var a = ["top", "right", "left", "bottom"], n = 0; n < a.length; n++) {
        var o = a[n];
        OrgChart.isNEU(OrgChart.miniMap.position[o]) || ("padding" == OrgChart.miniMap.position[o] ? (i.style[o] = t.config.padding + "px") : (i.style[o] = OrgChart.miniMap.position[o] + "px"));
      }
      (i.style.border = OrgChart.miniMap.border), (i.style.padding = OrgChart.miniMap.padding + "px"), (i.style.backgroundColor = OrgChart.miniMap.backgroundColor);
      var l = document.createElement("div");
      (l.style.position = "relative"), (l.style.width = OrgChart.miniMap.width + "px"), (l.style.height = OrgChart.miniMap.height + "px"), l.appendChild(e), l.appendChild(r), i.appendChild(l), t.element.appendChild(i);
      var s = function (e, r) {
      ...
      var h = 0,
        ...
        g = function () {
          document.removeEventListener("mousemove", c), document.removeEventListener("mouseup", g);
        };
      OrgChart.miniMap.draggable &&
        i.addEventListener("mousedown", function (t) {
          (h = t.clientX), (d = t.clientY), document.addEventListener("mousemove", c), document.addEventListener("mouseup", g);
        });
    }
  }),
  ...
  (OrgChart.miniMap.position = { top: void 0, left: "padding", right: void 0, bottom: "padding" }),
    ...
    for (var c = {}, g = 0; g < t.length; g++)
      for (var p = t[g], u = 0; u < r.length; u++) {
        ...
        if (!OrgChart.isNEU(p[f])) {
          var m = p[f];
          if (null != (e = OrgChart._search.searchAndComputeScore(h, m, f, n))) {
            var C = p.id;
            if (c[C]) {
              if (c[C] && c[C] < e.__score) {
                c[C] = e.__score;
                for (var b = l.length - 1; b >= 0; b--) l[b].id == C && l.splice(b, 1);
                OrgChart._search.addNodeToResult(l, i, p, e, f, a);
              }
            } else (c[C] = e.__score), OrgChart._search.addNodeToResult(l, i, p, e, f, a);
          }
        }
      }
    return (
  ...
  (OrgChart._search.searchAndComputeScore = function (t, e, r, i) {
    ...
    for (var o = a.length / 100, l = 0, s = 0, h = l > 0 ? 100 : 0, d = 0, c = 0; c < t.length; c++)
    ...
    if (n.length) {
      ...
      for (p = 0; p < n.length; p++)
        if (((l += n[p].length), n[p].start < s && (s = n[p].start), p >= 1 && n[p - 1].start > n[p].start)) {
          h = 0;
          break;
        }
    }
    ...
    0 != s && (m = 100 - s / o);
    var C = 0;
    i && i[r] && (C = i[r]), u && (u = (u / 100) * 50), f > 0 && (f = (f / 100) * 10), m > 0 && (m = (m / 100) * 10), h > 0 && (h = (h / 100) * 10), C > 0 && (C = (C / 100) * 20);
    var b = Math.round(1e4 * (u + f + m + h + C));
    n.sort(function (t, e) {
      return t.start < e.start ? -1 : t.start > e.start ? 1 : 0;
    });
    var O = e;
    for (p = n.length - 1; p >= 0; p--) O = (O = O.insert(n[p].start + n[p].length, "</mark>")).insert(n[p].start, "<mark>");
    return { __searchMarks: O, __score: b };
  }),
  (OrgChart._search.searchIndexesOf = function (t, e) {
    ...
    if (!OrgChart.isNEU(t))
      for (var i = 0; i < e.length; i++) {
        var a = e[i];
        if (!OrgChart.isNEU(a)) for (var n = 0; (n = t.indexOf(a, n)) > -1; ) r.push({ length: a.length, start: n, searchPhrase: a }), (n += a.length);
      }
    return (
      r.sort(function (t, e) {
  ...
  OrgChart.events.on("redraw", function (t, e) {
    if (t.config.state) {
      ...
      !(function t(e) {
        ...
        OrgChart.state._put(t.config.roots, t.width(), t.height(), t.response.viewBox, r, i, t.response.adjustify, t.config.state);
    }
  }),
  (OrgChart.state = {}),
  (OrgChart.state._buildStateNames = function (t) {
    return { paramScale: t + "-scale", paramX: t + "-x", paramY: t + "-y", paramExp: t + "-exp", paramMin: t + "-min", paramRoots: t + "-roots", paramAdjustify: t + "-adjustify" };
  }),
  (OrgChart.state._put = function (t, e, r, i, a, n, o, l) {
    if (l && !OrgChart.isNEU(a) && 0 != a.length) {
      var s = OrgChart.state._buildStateNames(l.name),
        h = { roots: t, scale: Math.min(e / i[2], r / i[3]), x: i[0], y: i[1], exp: a, min: n, adjustify: o };
      if (l.writeToUrlParams) {
        var d = new URLSearchParams(window.location.search);
        d.has(s.paramScale) ? d.set(s.paramScale, h.scale) : d.append(s.paramScale, h.scale),
          d.has(s.paramX) ? d.set(s.paramX, h.x) : d.append(s.paramX, h.x),
          d.has(s.paramY) ? d.set(s.paramY, h.y) : d.append(s.paramY, h.y),
          d.has(s.paramExp) ? d.set(s.paramExp, h.exp.join("*")) : d.append(s.paramExp, h.exp.join("*")),
          d.has(s.paramRoots) && Array.isArray(h.roots) ? d.set(s.paramRoots, h.roots.join("*")) : Array.isArray(h.roots) && d.append(s.paramRoots, h.roots.join("*")),
          d.has(s.paramMin) ? d.set(s.paramMin, h.min.join("*")) : d.append(s.paramMin, h.min.join("*")),
          d.has(s.paramAdjustify) ? d.set(s.paramAdjustify, h.adjustify.x + "*" + h.adjustify.y) : d.append(s.paramAdjustify, h.adjustify.x + "*" + h.adjustify.y),
    ...
    if (t) {
      ...
      if (t.readFromUrlParams) {
        ...
        if (n.has(a.paramScale) && n.has(a.paramX) && n.has(a.paramY) && n.has(a.paramExp) && n.has(a.paramMin) && n.has(a.paramAdjustify)) {
          ...
          return (o.adjustify = { x: parseFloat(d[0]), y: parseFloat(d[1]) }), void i(o);
        }
  ...
  (OrgChart.prototype.magnify = function (t, e, r, i, a) {
    ...
    if (n || o) {
      ...
      if ((l && (null != l.timer && clearInterval(l.timer), null != l.timerBack && clearInterval(l.timerBack), o.setAttribute("transform", "matrix(" + l.transformStart.toString() + ")"), (OrgChart._magnify[t] = null)), r))
  ...
  OrgChart.events.on("init", function (t, e) {
    if (t.config.keyNavigation && (t._addEvent(window, "keydown", t._windowKeyDownHandler), OrgChart.isNEU(t._keyNavigationActiveNodeId) && t.roots && t.roots.length)) {
      var r = t.roots[0].id;
      OrgChart.isNEU(t.config.keyNavigation.focusId) || (r = t.config.keyNavigation.focusId), (t._keyNavigationActiveNodeId = r), t.center(t._keyNavigationActiveNodeId);
    }
  }),
  ...
  OrgChart.events.on("click", function (t, e) {
    t.config && t.config.keyNavigation && ((t._keyNavigationActiveNodeId = e.node.id), t.center(e.node.id));
  }),
  (OrgChart._keyNavigation = function (t) {
    ...
    if (!OrgChart.isNEU(t._keyNavigationActiveNodeId) && (r = t.getNodeElement(t._keyNavigationActiveNodeId)) && r.children.length) {
      ...
      OrgChart.SEARCH_CLOSE_RESULT_ON_ESCAPE_OR_CLICKOUTSIDE && t.searchUI.hide(), i.focus();
    }
  }),
  (OrgChart.elements = {}),
  (OrgChart.elements.textbox = function (t, e, r, i) {
    ...
    var n = "";
    return (
      e.btn && (n = `<a href="#" data-input-btn="" class="boc-link boc-link-boc-button">${e.btn}</a>`),
      {
        html: `<div class="boc-form-field" style="min-width: ${r};">\n                    <div class="boc-input" data-boc-input="" ${a.disabledAttribute} ${a.vlidators}>\n                        <label for="${
          a.id
        }">${OrgChart._escapeGreaterLessSign(a.label)}</label>\n                        <input ${a.readOnlyAttribute} data-binding="${OrgChart._escapeDoubleQuotes(a.binding)}" maxlength="256" id="${a.id}" name="${
          a.id
        }" type="text" value="${OrgChart._escapeDoubleQuotes(a.value)}" autocomplete="off">\n                        ${n}\n                    </div>\n                </div>`,
        id: a.id,
        value: a.value,
      }
    );
  ...
  (OrgChart.elements.checkbox = function (t, e, r, i) {
    ...
    return {
      html: `<div class="boc-form-field"  style="min-width: ${r};" >\n                        <label class="boc-checkbox" data-boc-input="" ${
        a.disabledAttribute
      }>\n                            <input ${n} ${o} data-binding="${OrgChart._escapeDoubleQuotes(a.binding)}" type="checkbox"><span class="boc-checkbox-checkmark" type="checkbox"></span>${OrgChart._escapeGreaterLessSign(
        a.label
      )}\n                        </label>\n                    </div>`,
      id: a.id,
      value: n,
  ...
  (OrgChart.elements.select = function (t, e, r, i) {
    ...
    return a.doNotRender
      ...
      : {
          html: `<div class="boc-form-field" style="min-width: ${r};">\n                    <div class="boc-input" data-boc-input="" ${a.disabledAttribute} ${a.vlidators}>\n                        <label for="${
            a.id
          }">${OrgChart._escapeGreaterLessSign(a.label)}</label>\n                        <select data-binding="${OrgChart._escapeDoubleQuotes(a.binding)}" ${a.readOnlyAttribute} id="${a.id}" name="${
            a.id
          }">\n                            ${(function () {
            for (var t = "", e = 0; e < a.options.length; e++) {
              var r = a.options[e];
              t += `<option ${r.value == a.value ? "selected" : ""} value="${OrgChart._escapeDoubleQuotes(r.value)}">${OrgChart._escapeGreaterLessSign(r.text)}</option>`;
            }
            return t;
          })()}                           \n                        </select>\n                    </div>\n                </div>`,
          id: a.id,
  ...
  (OrgChart.elements.date = function (t, e, r, i) {
    ...
    return a.doNotRender
      ...
      : {
          html: `<div class="boc-form-field" style="min-width: ${r};">\n                    <div class="boc-input" data-boc-input="" ${a.disabledAttribute} ${a.vlidators}>\n                        <label for="${
            a.id
          }" class="hasval">${OrgChart._escapeGreaterLessSign(a.label)}</label>\n                        <input data-binding="${OrgChart._escapeDoubleQuotes(a.binding)}" ${a.readOnlyAttribute} maxlength="256" id="${a.id}" name="${
            a.id
          }" type="date" value="${OrgChart._escapeDoubleQuotes(a.value)}" autocomplete="off">\n                    </div>\n                </div>`,
          id: a.id,
          value: a.value,
        };
  }),
  ...
  (OrgChart.input.blurHandler = function (t) {
    ...
    e.classList.remove("focused"), t.value || "date" == t.type ? e.classList.add("hasval") : e.classList.remove("hasval");
  }),
  (OrgChart.input.validate = function (t) {
    ...
    return a && "" == e.value
      ? ((r.innerHTML += '<span class="boc-validation-error-message">&nbsp;' + a + "</span>"), e.classList.add("boc-validation-error"), !1)
      : n && !OrgChart.input.validatePassword(e.value)
      ? ((r.innerHTML += '<span class="boc-validation-error-message">&nbsp;' + n + "</span>"), e.classList.add("boc-validation-error"), !1)
      : o && !OrgChart.input.isValidEmail(e.value)
      ? ((r.innerHTML += '<span class="boc-validation-error-message">&nbsp;' + o + "</span>"), e.classList.add("boc-validation-error"), !1)
      : !(l && !OrgChart.input.isValidEmails(e.value)) || ((r.innerHTML += '<span class="boc-validation-error-message">&nbsp;' + l + "</span>"), e.classList.add("boc-validation-error"), !1);
  }),
  ...
  (OrgChart.filterUI.prototype.init = function (t) {
    (this.instance = t), (this.element = null), (this.filterBy = null), (this._event_id = OrgChart._guid());
  }),
  ...
  (OrgChart.filterUI.prototype.update = function () {
    if (this.instance.config.filterBy) {
      ...
      if ("all" == this.instance.config.filterBy)
        for (var e = OrgChart.manager.getAllFields(this.instance.config), r = 0; r < e.length; r++) {
          var i = e[r];
          "tags" != i && "id" != i && "pid" != i && "ppid" != i && "stpid" != i && (t[i] = {});
        }
      else if (Array.isArray(this.instance.config.filterBy)) for (r = 0; r < this.instance.config.filterBy.length; r++) t[this.instance.config.filterBy[r]] = {};
      else if ("object" == typeof this.instance.config.filterBy) for (var a in this.instance.config.filterBy) t[a] = {};
      for (var n in t) {
        var o = t[n];
      ...
      if (null != this.filterBy) for (var s in t) if (this.filterBy[s]) for (var h in t[s]) this.filterBy[s][h] && (t[s][h] = this.filterBy[s][h]);
      this.filterBy = t;
      var d = this;
      (this.element = this.instance.element.querySelector("[data-filter]")),
        ...
        this.instance.config.undoRedoStorageName
          ? ((this.element.style.top = 0), (this.element.style.left = "50%"), (this.element.style.transform = "translate(-50%)"))
          : ((this.element.style.top = this.instance.config.padding + "px"), (this.element.style.left = this.instance.config.padding + "px"));
      var c = "";
      ...
      (this.element.innerHTML = `<div>${c}</div>`),
        this.element.addEventListener("click", function (t) {
          if (t.target.hasAttribute("data-filter-close") || t.target.hasAttribute("data-filter-field")) {
            for (var e = t.target.getAttribute("data-filter-field"), r = d.instance.element.querySelectorAll("[data-filter-menu]"), i = 0; i < r.length; i++) r[i].style.display = "none";
            var a = d.instance.element.querySelectorAll(".filter-field-selected");
            for (i = 0; i < a.length; i++) a[i].classList.remove("filter-field-selected");
            var n = d.instance.element.querySelector("[data-filter-close]");
            if ((n && n.parentNode.removeChild(n), t.target.hasAttribute("data-filter-close"))) return;
            if (!t.target.hasAttribute("data-filter-field")) return;
            var o = d.instance.element.querySelector(`[data-filter-menu="${e}"]`);
            if (!o) {
              var l = {
                name: e,
                text: "[All]",
              ...
              for (var h in d.filterBy[e]) {
                ...
                null == g && (g = h),
                  (l = {
                    ...
                    value: h,
                    checked: c.checked,
                    html: `<div>\n                            <input  type="checkbox" id="${h}" name="${h}" ${c.checked ? "checked" : ""}>\n                            <label for="${h}">${g}</label>\n                        </div>`,
                  }),
                  OrgChart.events.publish("add-item", [d, l]),
                  (s += l.html);
              }
              ((o =
                document.createElement(
                  "div"
                )).innerHTML = `<fieldset>\n                                                    <legend>Filter by ${e}:</legend>\n                                                    ${s}\n                                                </fieldset>`),
                o.setAttribute("data-filter-menu", e),
                o.classList.add("boc-filter-menu"),
                t.target.parentNode.parentNode.appendChild(o);
              var p = o.querySelectorAll("input");
              for (i = 0; i < p.length; i++)
                p[i].addEventListener("change", function (t) {
                  for (var e = t.target; e && !e.hasAttribute("data-filter-menu"); ) e = e.parentNode;
                  if (e) {
                    var r = e.getAttribute("data-filter-menu");
                    if (t.target.hasAttribute("data-all")) {
                      for (var i = t.target.parentNode.parentNode.querySelectorAll("input"), a = 0; a < i.length; a++)
                        if (i[a] != t.target) for (var n in ((i[a].checked = t.target.checked), d.filterBy[r])) d.filterBy[r][n].checked = t.target.checked;
                    } else if ((null != d.filterBy[r][this.name] && (d.filterBy[r][this.name].checked = this.checked), this.checked))
                      for (var o = d.instance.config.nodes, l = 0; l < o.length; l++)
                        if (o[l][r] == this.name)
                          for (var s = o[l]; s; )
                            if (OrgChart.isNEU(s.stpid)) s = OrgChart.isNEU(s.pid) ? null : d.instance._get(s.pid);
                            else if ((s = d.instance._get(s.stpid))[r]) {
                              var h = t.target.parentNode.parentNode.querySelector('[name="' + s[r] + '"]');
                              h ? ((h.checked = this.checked), (d.filterBy[r][s[r]].checked = this.checked)) : console.error('Cannot find element with selector: [name="' + s[r] + '"]');
                            }
                    d.instance.draw();
                  }
                });
  ...
  (OrgChart.remote._toReqDTO = function (t, e) {
    ...
    t.children.length > 0 && (r.c = OrgChart.remote._convertToIdArray(t.children)),
      t.stChildren.length > 0 && (r.v = OrgChart.remote._convertToIdArray(t.stChildren)),
  ...
  (OrgChart.remote._setPositions = function (t, e, r, i) {
    ...
    if ((OrgChart.LIMIT_NODES || (s.l = !0), null != OrgChart.remote._fromReqDTO))
  ...
  (OrgChart.remote._findRegion = function (t) {
    ...
    if (e) t(e);
      ...
      for (
        var r = ["au-e", "au-se", "brs", "ca", "ca-e", "easia", "eus-2", "eus", "fr", "ind", "jp-e", "jp-w", "kr", "n-eu", "se-asia", "s-ind", "uk-s", "uk-w", "us", "us-n-c", "us-s-c", "w-c-us", "w-eu", "w-ind", "w-us-2", "wus"],
          i = [],
          a = 0;
        a < r.length;
        a++
